...
## [0.61.1](https://github.com/instill-ai/pipeline-backend/compare/v0.61.0...v0.61.1) (2026-05-04)
...
* **data:** add SVG image format support with chromium headless conversion ([05211a0](https://github.com/instill-ai/pipeline-backend/commit/05211a00d91e81f75cd2470987155ad95cd53f0b))
* **data:** add two-pass ffmpeg video normalization for Gemini API compliance ([6e0f49f](https://github.com/instill-ai/pipeline-backend/commit/6e0f49f5457b405f44713990f1b117109446f8aa))
...
* **data:** generalize document conversion to support arbitrary target formats ([40787d7](https://github.com/instill-ai/pipeline-backend/commit/40787d7f457d6768b2e750f5a8005ec1b515f7dc))
* **grpc:** increase MaxPayloadSize from 256 MB to 2 GB ([0c070c1](https://github.com/instill-ai/pipeline-backend/commit/0c070c129e50a212d4d683708656389b4db368d9))
...
* **component:** use dns:/// resolver and round_robin LB for gRPC clients ([7dee681](https://github.com/instill-ai/pipeline-backend/commit/7dee68127691659fa84528caa80fd5e1b69748d8))
* **deps:** bump x for OpenFGA gRPC dns:/// + round_robin LB fix ([8cfa567](https://github.com/instill-ai/pipeline-backend/commit/8cfa5676e5528163d4ee2c9fa7fbee2cd26ae367))
* **deps:** bump x for periodic DNS re-resolution resolver ([bd2948d](https://github.com/instill-ai/pipeline-backend/commit/bd2948d9bf02a9edd047100ca57c9c426b1e54b1))
...
* **ci:** remove maximize-build-space action ([332c640](https://github.com/instill-ai/pipeline-backend/commit/332c64020f297166a06f4e19b6b6c5c239cbf682))
* **ci:** replace maximize-build-space with free-disk-space action ([1008a09](https://github.com/instill-ai/pipeline-backend/commit/1008a09acbdfb915a6d29fdc2c4454beb6bf50b1))
...
* **mock:** regenerate repository mock after x/acl interface change ([2590c2c](https://github.com/instill-ai/pipeline-backend/commit/2590c2c572bb59c26a7d845cda6f6dc3860f2d15))
...
* **api:** migrate Integration/Connection types to mgmt protobuf and update CreateFile parent format ([#1155](https://github.com/instill-ai/pipeline-backend/issues/1155)) ([7b472f1](https://github.com/instill-ai/pipeline-backend/commit/7b472f16571aaac37a497aa2f345c7b12cd1aa9f))
* **api:** rename NamespaceConnection APIs to Connection and move to pipeline proto ([#1157](https://github.com/instill-ai/pipeline-backend/issues/1157)) ([c4cfb8b](https://github.com/instill-ai/pipeline-backend/commit/c4cfb8bf9e1a4fcd75116e261c9dbd4c68b3be8a))
...
* **config:** align pipeline and artifact endpoints with AIP naming ([#1156](https://github.com/instill-ai/pipeline-backend/issues/1156)) ([af347e7](https://github.com/instill-ai/pipeline-backend/commit/af347e746b7acb9cac224a3a0110432f6fb4a7b5))
