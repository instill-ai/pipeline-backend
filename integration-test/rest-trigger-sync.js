...
export function CheckTriggerSyncSingleImageSingleModelInst() {
  ...
  group("Pipelines API: Trigger a pipeline for single image and single model instance", () => {
    ...
    check(http.request("POST", `${pipelineHost}/v1alpha/pipelines/${reqHTTP.id}:trigger`, JSON.stringify(payloadImageURL), {
      ...
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (url) response model_instance_outputs[0].task_outputs[0].detection.detection_objects.length`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects.length === 1,
      ...
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (url) response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].category`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].category === "test",
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (url) response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].score`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].score === 1,
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (url) response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].bounding_box`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].bounding_box !== undefined,
    });
    ...
    check(http.request("POST", `${pipelineHost}/v1alpha/pipelines/${reqHTTP.id}:trigger`, JSON.stringify(payloadImageBase64), {
      ...
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (base64) response model_instance_outputs[0].task_outputs[0].detection.detection_objects.length`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects.length === 1,
      ...
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (base64) response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].category`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].category === "test",
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (base64) response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].score`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].score === 1,
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger (base64) response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].bounding_box`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].bounding_box !== undefined,
    });
    ...
    check(http.request("POST", `${pipelineHost}/v1alpha/pipelines/${reqHTTP.id}:trigger-multipart`, fd.body(), {
      ...
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger-multipart response model_instance_outputs[0].task_outputs[0].detection.detection_objects.length`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects.length === 1,
      ...
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger-multipart response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].category`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].category === "test",
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger-multipart response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].score`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].score === 1,
      [`POST /v1alpha/pipelines/${reqHTTP.id}:trigger-multipart response model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].bounding_box`]: (r) => r.json().model_instance_outputs[0].task_outputs[0].detection.detection_objects[0].bounding_box !== undefined,
    });
