...
type RepositoryMock struct {
	...
	funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions          func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) (ca1 []datamodel.ComponentRun, i1 int64, err error)
	inspectFuncGetPaginatedComponentRunsByPipelineRunIDWithPermissions   func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline)
	...
	funcGetPaginatedPipelineRunsWithPermissions          func(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) (pa1 []datamodel.PipelineRun, i1 int64, err error)
	inspectFuncGetPaginatedPipelineRunsWithPermissions   func(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline)
	...
	if mmCheckPinnedUser.CheckPinnedUserMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.dp1 != nil && !minimock.Equal(*mm_want_ptrs.dp1, mm_got.dp1) {
				mmCheckPinnedUser.t.Errorf("RepositoryMock.CheckPinnedUser got unexpected parameter dp1, want: %#v, got: %#v%s\n", *mm_want_ptrs.dp1, mm_got.dp1, minimock.Diff(*mm_want_ptrs.dp1, mm_got.dp1))
			}
...
// CreateNamespaceConnection implements repository.Repository
func (mmCreateNamespaceConnection *RepositoryMock) CreateNamespaceConnection(ctx context.Context, cp1 *datamodel.Connection) (cp2 *datamodel.Connection, err error) {
	...
	if mmCreateNamespaceConnection.CreateNamespaceConnectionMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreateNamespaceConnection.t.Errorf("RepositoryMock.CreateNamespaceConnection got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.cp1 != nil && !minimock.Equal(*mm_want_ptrs.cp1, mm_got.cp1) {
				mmCreateNamespaceConnection.t.Errorf("RepositoryMock.CreateNamespaceConnection got unexpected parameter cp1, want: %#v, got: %#v%s\n", *mm_want_ptrs.cp1, mm_got.cp1, minimock.Diff(*mm_want_ptrs.cp1, mm_got.cp1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCreateNamespaceConnection.t.Errorf("RepositoryMock.CreateNamespaceConnection got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockCreateNamespaceConnectionInspect() {
	for _, e := range m.CreateNamespaceConnectionMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.CreateNamespaceConnection with params: %#v", *e.params)
		}
	}
	...
	if m.CreateNamespaceConnectionMock.defaultExpectation != nil && afterCreateNamespaceConnectionCounter < 1 {
		if m.CreateNamespaceConnectionMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.CreateNamespaceConnection")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.CreateNamespaceConnection with params: %#v", *m.CreateNamespaceConnectionMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.CreateNamespaceConnectionMock.invocationsDone() && afterCreateNamespaceConnectionCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.CreateNamespaceConnection but found %d calls",
			mm_atomic.LoadUint64(&m.CreateNamespaceConnectionMock.expectedInvocations), afterCreateNamespaceConnectionCounter)
	}
}
...
// DeleteNamespaceConnectionByID implements repository.Repository
func (mmDeleteNamespaceConnectionByID *RepositoryMock) DeleteNamespaceConnectionByID(ctx context.Context, nsUID uuid.UUID, id string) (err error) {
	...
	if mmDeleteNamespaceConnectionByID.DeleteNamespaceConnectionByIDMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmDeleteNamespaceConnectionByID.t.Errorf("RepositoryMock.DeleteNamespaceConnectionByID got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.nsUID != nil && !minimock.Equal(*mm_want_ptrs.nsUID, mm_got.nsUID) {
				mmDeleteNamespaceConnectionByID.t.Errorf("RepositoryMock.DeleteNamespaceConnectionByID got unexpected parameter nsUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.nsUID, mm_got.nsUID, minimock.Diff(*mm_want_ptrs.nsUID, mm_got.nsUID))
			}

			if mm_want_ptrs.id != nil && !minimock.Equal(*mm_want_ptrs.id, mm_got.id) {
				mmDeleteNamespaceConnectionByID.t.Errorf("RepositoryMock.DeleteNamespaceConnectionByID got unexpected parameter id, want: %#v, got: %#v%s\n", *mm_want_ptrs.id, mm_got.id, minimock.Diff(*mm_want_ptrs.id, mm_got.id))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmDeleteNamespaceConnectionByID.t.Errorf("RepositoryMock.DeleteNamespaceConnectionByID got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockDeleteNamespaceConnectionByIDInspect() {
	for _, e := range m.DeleteNamespaceConnectionByIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.DeleteNamespaceConnectionByID with params: %#v", *e.params)
		}
	}
	...
	if m.DeleteNamespaceConnectionByIDMock.defaultExpectation != nil && afterDeleteNamespaceConnectionByIDCounter < 1 {
		if m.DeleteNamespaceConnectionByIDMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.DeleteNamespaceConnectionByID")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.DeleteNamespaceConnectionByID with params: %#v", *m.DeleteNamespaceConnectionByIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.DeleteNamespaceConnectionByIDMock.invocationsDone() && afterDeleteNamespaceConnectionByIDCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.DeleteNamespaceConnectionByID but found %d calls",
			mm_atomic.LoadUint64(&m.DeleteNamespaceConnectionByIDMock.expectedInvocations), afterDeleteNamespaceConnectionByIDCounter)
	}
}
...
// GetNamespaceConnectionByID implements repository.Repository
func (mmGetNamespaceConnectionByID *RepositoryMock) GetNamespaceConnectionByID(ctx context.Context, nsUID uuid.UUID, id string) (cp1 *datamodel.Connection, err error) {
	...
	if mmGetNamespaceConnectionByID.GetNamespaceConnectionByIDMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetNamespaceConnectionByID.t.Errorf("RepositoryMock.GetNamespaceConnectionByID got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.nsUID != nil && !minimock.Equal(*mm_want_ptrs.nsUID, mm_got.nsUID) {
				mmGetNamespaceConnectionByID.t.Errorf("RepositoryMock.GetNamespaceConnectionByID got unexpected parameter nsUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.nsUID, mm_got.nsUID, minimock.Diff(*mm_want_ptrs.nsUID, mm_got.nsUID))
			}

			if mm_want_ptrs.id != nil && !minimock.Equal(*mm_want_ptrs.id, mm_got.id) {
				mmGetNamespaceConnectionByID.t.Errorf("RepositoryMock.GetNamespaceConnectionByID got unexpected parameter id, want: %#v, got: %#v%s\n", *mm_want_ptrs.id, mm_got.id, minimock.Diff(*mm_want_ptrs.id, mm_got.id))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetNamespaceConnectionByID.t.Errorf("RepositoryMock.GetNamespaceConnectionByID got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockGetNamespaceConnectionByIDInspect() {
	for _, e := range m.GetNamespaceConnectionByIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.GetNamespaceConnectionByID with params: %#v", *e.params)
		}
	}
	...
	if m.GetNamespaceConnectionByIDMock.defaultExpectation != nil && afterGetNamespaceConnectionByIDCounter < 1 {
		if m.GetNamespaceConnectionByIDMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.GetNamespaceConnectionByID")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.GetNamespaceConnectionByID with params: %#v", *m.GetNamespaceConnectionByIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetNamespaceConnectionByIDMock.invocationsDone() && afterGetNamespaceConnectionByIDCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.GetNamespaceConnectionByID but found %d calls",
			mm_atomic.LoadUint64(&m.GetNamespaceConnectionByIDMock.expectedInvocations), afterGetNamespaceConnectionByIDCounter)
	}
}
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) Expect(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	...
	mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.defaultExpectation.params = &RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline}
...
// ExpectFilterParam6 sets up expected param filter for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectFilterParam6(filter filtering.Filter) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
...
// ExpectOrderParam7 sets up expected param order for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectOrderParam7(order ordering.OrderBy) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
...
// ExpectDbPipelineParam8 sets up expected param dbPipeline for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectDbPipelineParam8(dbPipeline *datamodel.Pipeline) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
	...
	mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.defaultExpectation.paramPtrs.dbPipeline = &dbPipeline
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) Inspect(f func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline)) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) Set(f func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) (ca1 []datamodel.ComponentRun, i1 int64, err error)) *RepositoryMock {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.defaultExpectation != nil {
...
// Then helper
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) When(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) *RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsExpectation {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
	...
	expectation := &RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsExpectation{
		...
		params: &RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline},
	}
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *RepositoryMock) GetPaginatedComponentRunsByPipelineRunIDWithPermissions(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) (ca1 []datamodel.ComponentRun, i1 int64, err error) {
	...
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.inspectFuncGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.inspectFuncGetPaginatedComponentRunsByPipelineRunIDWithPermissions(ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline)
	}

	mm_params := RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline}
	...
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.filter != nil && !minimock.Equal(*mm_want_ptrs.filter, mm_got.filter) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter filter, want: %#v, got: %#v%s\n", *mm_want_ptrs.filter, mm_got.filter, minimock.Diff(*mm_want_ptrs.filter, mm_got.filter))
			}

			if mm_want_ptrs.order != nil && !minimock.Equal(*mm_want_ptrs.order, mm_got.order) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter order, want: %#v, got: %#v%s\n", *mm_want_ptrs.order, mm_got.order, minimock.Diff(*mm_want_ptrs.order, mm_got.order))
			}

			if mm_want_ptrs.dbPipeline != nil && !minimock.Equal(*mm_want_ptrs.dbPipeline, mm_got.dbPipeline) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter dbPipeline, want: %#v, got: %#v%s\n", *mm_want_ptrs.dbPipeline, mm_got.dbPipeline, minimock.Diff(*mm_want_ptrs.dbPipeline, mm_got.dbPipeline))
			}
	...
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		return mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions(ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline)
	}
	mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Fatalf("Unexpected call to RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions. %v %v %v %v %v %v %v %v", ctx, userID, pipelineRunID, page, pageSize, filter, order, dbPipeline)
	return
}
...
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) Expect(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
	...
	mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation.params = &RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline}
...
// ExpectDbPipelineParam8 sets up expected param dbPipeline for Repository.GetPaginatedPipelineRunsWithPermissions
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) ExpectDbPipelineParam8(dbPipeline *datamodel.Pipeline) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
	if mmGetPaginatedPipelineRunsWithPermissions.mock.funcGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions mock is already set by Set")
	}
	...
	mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation.paramPtrs.dbPipeline = &dbPipeline

	return mmGetPaginatedPipelineRunsWithPermissions
}

// Inspect accepts an inspector function that has same arguments as the Repository.GetPaginatedPipelineRunsWithPermissions
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) Inspect(f func(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline)) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
...
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) Set(f func(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) (pa1 []datamodel.PipelineRun, i1 int64, err error)) *RepositoryMock {
	if mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation != nil {
...
// Then helper
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) When(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) *RepositoryMockGetPaginatedPipelineRunsWithPermissionsExpectation {
	if mmGetPaginatedPipelineRunsWithPermissions.mock.funcGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions mock is already set by Set")
	}
	...
	expectation := &RepositoryMockGetPaginatedPipelineRunsWithPermissionsExpectation{
		...
		params: &RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline},
	}
...
func (mmGetPaginatedPipelineRunsWithPermissions *RepositoryMock) GetPaginatedPipelineRunsWithPermissions(ctx context.Context, userID string, pipelineUID string, page int, pageSize int, filter filtering.Filter, order ordering.OrderBy, dbPipeline *datamodel.Pipeline) (pa1 []datamodel.PipelineRun, i1 int64, err error) {
	...
	if mmGetPaginatedPipelineRunsWithPermissions.inspectFuncGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.inspectFuncGetPaginatedPipelineRunsWithPermissions(ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline)
	}

	mm_params := RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline}
	...
	if mmGetPaginatedPipelineRunsWithPermissions.GetPaginatedPipelineRunsWithPermissionsMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.pipelineUID != nil && !minimock.Equal(*mm_want_ptrs.pipelineUID, mm_got.pipelineUID) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter pipelineUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.pipelineUID, mm_got.pipelineUID, minimock.Diff(*mm_want_ptrs.pipelineUID, mm_got.pipelineUID))
			}
			...
			if mm_want_ptrs.filter != nil && !minimock.Equal(*mm_want_ptrs.filter, mm_got.filter) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter filter, want: %#v, got: %#v%s\n", *mm_want_ptrs.filter, mm_got.filter, minimock.Diff(*mm_want_ptrs.filter, mm_got.filter))
			}

			if mm_want_ptrs.order != nil && !minimock.Equal(*mm_want_ptrs.order, mm_got.order) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter order, want: %#v, got: %#v%s\n", *mm_want_ptrs.order, mm_got.order, minimock.Diff(*mm_want_ptrs.order, mm_got.order))
			}

			if mm_want_ptrs.dbPipeline != nil && !minimock.Equal(*mm_want_ptrs.dbPipeline, mm_got.dbPipeline) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter dbPipeline, want: %#v, got: %#v%s\n", *mm_want_ptrs.dbPipeline, mm_got.dbPipeline, minimock.Diff(*mm_want_ptrs.dbPipeline, mm_got.dbPipeline))
			}
	...
	if mmGetPaginatedPipelineRunsWithPermissions.funcGetPaginatedPipelineRunsWithPermissions != nil {
		return mmGetPaginatedPipelineRunsWithPermissions.funcGetPaginatedPipelineRunsWithPermissions(ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline)
	}
	mmGetPaginatedPipelineRunsWithPermissions.t.Fatalf("Unexpected call to RepositoryMock.GetPaginatedPipelineRunsWithPermissions. %v %v %v %v %v %v %v %v", ctx, userID, pipelineUID, page, pageSize, filter, order, dbPipeline)
	return
}
...
// GetPipelineReleaseByUIDAdmin implements repository.Repository
func (mmGetPipelineReleaseByUIDAdmin *RepositoryMock) GetPipelineReleaseByUIDAdmin(ctx context.Context, uid uuid.UUID, isBasicView bool) (pp1 *datamodel.PipelineRelease, err error) {
	...
	if mmGetPipelineReleaseByUIDAdmin.GetPipelineReleaseByUIDAdminMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetPipelineReleaseByUIDAdmin.t.Errorf("RepositoryMock.GetPipelineReleaseByUIDAdmin got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.uid != nil && !minimock.Equal(*mm_want_ptrs.uid, mm_got.uid) {
				mmGetPipelineReleaseByUIDAdmin.t.Errorf("RepositoryMock.GetPipelineReleaseByUIDAdmin got unexpected parameter uid, want: %#v, got: %#v%s\n", *mm_want_ptrs.uid, mm_got.uid, minimock.Diff(*mm_want_ptrs.uid, mm_got.uid))
			}

			if mm_want_ptrs.isBasicView != nil && !minimock.Equal(*mm_want_ptrs.isBasicView, mm_got.isBasicView) {
				mmGetPipelineReleaseByUIDAdmin.t.Errorf("RepositoryMock.GetPipelineReleaseByUIDAdmin got unexpected parameter isBasicView, want: %#v, got: %#v%s\n", *mm_want_ptrs.isBasicView, mm_got.isBasicView, minimock.Diff(*mm_want_ptrs.isBasicView, mm_got.isBasicView))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetPipelineReleaseByUIDAdmin.t.Errorf("RepositoryMock.GetPipelineReleaseByUIDAdmin got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockGetPipelineReleaseByUIDAdminInspect() {
	for _, e := range m.GetPipelineReleaseByUIDAdminMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.GetPipelineReleaseByUIDAdmin with params: %#v", *e.params)
		}
	}
	...
	if m.GetPipelineReleaseByUIDAdminMock.defaultExpectation != nil && afterGetPipelineReleaseByUIDAdminCounter < 1 {
		if m.GetPipelineReleaseByUIDAdminMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.GetPipelineReleaseByUIDAdmin")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.GetPipelineReleaseByUIDAdmin with params: %#v", *m.GetPipelineReleaseByUIDAdminMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetPipelineReleaseByUIDAdminMock.invocationsDone() && afterGetPipelineReleaseByUIDAdminCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.GetPipelineReleaseByUIDAdmin but found %d calls",
			mm_atomic.LoadUint64(&m.GetPipelineReleaseByUIDAdminMock.expectedInvocations), afterGetPipelineReleaseByUIDAdminCounter)
	}
}
...
// GetPipelineRunByUID implements repository.Repository
func (mmGetPipelineRunByUID *RepositoryMock) GetPipelineRunByUID(ctx context.Context, u1 uuid.UUID) (pp1 *datamodel.PipelineRun, err error) {
	...
	if mmGetPipelineRunByUID.GetPipelineRunByUIDMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetPipelineRunByUID.t.Errorf("RepositoryMock.GetPipelineRunByUID got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.u1 != nil && !minimock.Equal(*mm_want_ptrs.u1, mm_got.u1) {
				mmGetPipelineRunByUID.t.Errorf("RepositoryMock.GetPipelineRunByUID got unexpected parameter u1, want: %#v, got: %#v%s\n", *mm_want_ptrs.u1, mm_got.u1, minimock.Diff(*mm_want_ptrs.u1, mm_got.u1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetPipelineRunByUID.t.Errorf("RepositoryMock.GetPipelineRunByUID got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockGetPipelineRunByUIDInspect() {
	for _, e := range m.GetPipelineRunByUIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.GetPipelineRunByUID with params: %#v", *e.params)
		}
	}
	...
	if m.GetPipelineRunByUIDMock.defaultExpectation != nil && afterGetPipelineRunByUIDCounter < 1 {
		if m.GetPipelineRunByUIDMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.GetPipelineRunByUID")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.GetPipelineRunByUID with params: %#v", *m.GetPipelineRunByUIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetPipelineRunByUIDMock.invocationsDone() && afterGetPipelineRunByUIDCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.GetPipelineRunByUID but found %d calls",
			mm_atomic.LoadUint64(&m.GetPipelineRunByUIDMock.expectedInvocations), afterGetPipelineRunByUIDCounter)
	}
}
...
// ListNamespaceConnections implements repository.Repository
func (mmListNamespaceConnections *RepositoryMock) ListNamespaceConnections(ctx context.Context, l1 mm_repository.ListNamespaceConnectionsParams) (c2 mm_repository.ConnectionList, err error) {
	...
	if mmListNamespaceConnections.ListNamespaceConnectionsMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmListNamespaceConnections.t.Errorf("RepositoryMock.ListNamespaceConnections got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.l1 != nil && !minimock.Equal(*mm_want_ptrs.l1, mm_got.l1) {
				mmListNamespaceConnections.t.Errorf("RepositoryMock.ListNamespaceConnections got unexpected parameter l1, want: %#v, got: %#v%s\n", *mm_want_ptrs.l1, mm_got.l1, minimock.Diff(*mm_want_ptrs.l1, mm_got.l1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmListNamespaceConnections.t.Errorf("RepositoryMock.ListNamespaceConnections got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockListNamespaceConnectionsInspect() {
	for _, e := range m.ListNamespaceConnectionsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.ListNamespaceConnections with params: %#v", *e.params)
		}
	}
	...
	if m.ListNamespaceConnectionsMock.defaultExpectation != nil && afterListNamespaceConnectionsCounter < 1 {
		if m.ListNamespaceConnectionsMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.ListNamespaceConnections")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.ListNamespaceConnections with params: %#v", *m.ListNamespaceConnectionsMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.ListNamespaceConnectionsMock.invocationsDone() && afterListNamespaceConnectionsCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.ListNamespaceConnections but found %d calls",
			mm_atomic.LoadUint64(&m.ListNamespaceConnectionsMock.expectedInvocations), afterListNamespaceConnectionsCounter)
	}
}
...
// UpdateNamespaceConnectionByUID implements repository.Repository
func (mmUpdateNamespaceConnectionByUID *RepositoryMock) UpdateNamespaceConnectionByUID(ctx context.Context, u1 uuid.UUID, cp1 *datamodel.Connection) (cp2 *datamodel.Connection, err error) {
	...
	if mmUpdateNamespaceConnectionByUID.UpdateNamespaceConnectionByUIDMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmUpdateNamespaceConnectionByUID.t.Errorf("RepositoryMock.UpdateNamespaceConnectionByUID got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.u1 != nil && !minimock.Equal(*mm_want_ptrs.u1, mm_got.u1) {
				mmUpdateNamespaceConnectionByUID.t.Errorf("RepositoryMock.UpdateNamespaceConnectionByUID got unexpected parameter u1, want: %#v, got: %#v%s\n", *mm_want_ptrs.u1, mm_got.u1, minimock.Diff(*mm_want_ptrs.u1, mm_got.u1))
			}

			if mm_want_ptrs.cp1 != nil && !minimock.Equal(*mm_want_ptrs.cp1, mm_got.cp1) {
				mmUpdateNamespaceConnectionByUID.t.Errorf("RepositoryMock.UpdateNamespaceConnectionByUID got unexpected parameter cp1, want: %#v, got: %#v%s\n", *mm_want_ptrs.cp1, mm_got.cp1, minimock.Diff(*mm_want_ptrs.cp1, mm_got.cp1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpdateNamespaceConnectionByUID.t.Errorf("RepositoryMock.UpdateNamespaceConnectionByUID got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockUpdateNamespaceConnectionByUIDInspect() {
	for _, e := range m.UpdateNamespaceConnectionByUIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.UpdateNamespaceConnectionByUID with params: %#v", *e.params)
		}
	}
	...
	if m.UpdateNamespaceConnectionByUIDMock.defaultExpectation != nil && afterUpdateNamespaceConnectionByUIDCounter < 1 {
		if m.UpdateNamespaceConnectionByUIDMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.UpdateNamespaceConnectionByUID")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.UpdateNamespaceConnectionByUID with params: %#v", *m.UpdateNamespaceConnectionByUIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.UpdateNamespaceConnectionByUIDMock.invocationsDone() && afterUpdateNamespaceConnectionByUIDCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.UpdateNamespaceConnectionByUID but found %d calls",
			mm_atomic.LoadUint64(&m.UpdateNamespaceConnectionByUIDMock.expectedInvocations), afterUpdateNamespaceConnectionByUIDCounter)
	}
}
...
// UpdatePipelineRun implements repository.Repository
func (mmUpdatePipelineRun *RepositoryMock) UpdatePipelineRun(ctx context.Context, pipelineTriggerUID string, pipelineRun *datamodel.PipelineRun) (err error) {
	...
	if mmUpdatePipelineRun.UpdatePipelineRunMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmUpdatePipelineRun.t.Errorf("RepositoryMock.UpdatePipelineRun got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.pipelineTriggerUID != nil && !minimock.Equal(*mm_want_ptrs.pipelineTriggerUID, mm_got.pipelineTriggerUID) {
				mmUpdatePipelineRun.t.Errorf("RepositoryMock.UpdatePipelineRun got unexpected parameter pipelineTriggerUID, want: %#v, got: %#v%s\n", *mm_want_ptrs.pipelineTriggerUID, mm_got.pipelineTriggerUID, minimock.Diff(*mm_want_ptrs.pipelineTriggerUID, mm_got.pipelineTriggerUID))
			}

			if mm_want_ptrs.pipelineRun != nil && !minimock.Equal(*mm_want_ptrs.pipelineRun, mm_got.pipelineRun) {
				mmUpdatePipelineRun.t.Errorf("RepositoryMock.UpdatePipelineRun got unexpected parameter pipelineRun, want: %#v, got: %#v%s\n", *mm_want_ptrs.pipelineRun, mm_got.pipelineRun, minimock.Diff(*mm_want_ptrs.pipelineRun, mm_got.pipelineRun))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUpdatePipelineRun.t.Errorf("RepositoryMock.UpdatePipelineRun got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *RepositoryMock) MinimockUpdatePipelineRunInspect() {
	for _, e := range m.UpdatePipelineRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.UpdatePipelineRun with params: %#v", *e.params)
		}
	}
	...
	if m.UpdatePipelineRunMock.defaultExpectation != nil && afterUpdatePipelineRunCounter < 1 {
		if m.UpdatePipelineRunMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.UpdatePipelineRun")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.UpdatePipelineRun with params: %#v", *m.UpdatePipelineRunMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.UpdatePipelineRunMock.invocationsDone() && afterUpdatePipelineRunCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.UpdatePipelineRun but found %d calls",
			mm_atomic.LoadUint64(&m.UpdatePipelineRunMock.expectedInvocations), afterUpdatePipelineRunCounter)
	}
}
