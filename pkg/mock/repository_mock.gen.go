...
type RepositoryMock struct {
	...
	funcCreateOrUpdateComponentRun          func(ctx context.Context, componentRun *datamodel.ComponentRun) (err error)
	inspectFuncCreateOrUpdateComponentRun   func(ctx context.Context, componentRun *datamodel.ComponentRun)
	afterCreateOrUpdateComponentRunCounter  uint64
	beforeCreateOrUpdateComponentRunCounter uint64
	CreateOrUpdateComponentRunMock          mRepositoryMockCreateOrUpdateComponentRun

	funcCreateOrUpdatePipelineRun          func(ctx context.Context, pipelineRun *datamodel.PipelineRun) (err error)
	inspectFuncCreateOrUpdatePipelineRun   func(ctx context.Context, pipelineRun *datamodel.PipelineRun)
	afterCreateOrUpdatePipelineRunCounter  uint64
	beforeCreateOrUpdatePipelineRunCounter uint64
	CreateOrUpdatePipelineRunMock          mRepositoryMockCreateOrUpdatePipelineRun
	...
	funcGeneratePresignedURL          func(ctx context.Context, bucketName string, objectName string) (s1 string, err error)
	inspectFuncGeneratePresignedURL   func(ctx context.Context, bucketName string, objectName string)
	afterGeneratePresignedURLCounter  uint64
	beforeGeneratePresignedURLCounter uint64
	GeneratePresignedURLMock          mRepositoryMockGeneratePresignedURL
	...
	funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions          func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int) (ca1 []datamodel.ComponentRun, i1 int64, err error)
	inspectFuncGetPaginatedComponentRunsByPipelineRunIDWithPermissions   func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int)
	...
	funcGetPaginatedPipelineRunsWithPermissions          func(ctx context.Context, userID string, namespace string, page int, pageSize int) (pa1 []datamodel.PipelineRun, i1 int64, err error)
	inspectFuncGetPaginatedPipelineRunsWithPermissions   func(ctx context.Context, userID string, namespace string, page int, pageSize int)
	...
	funcUploadToMinio          func(ctx context.Context, objectName string, data []byte, contentType string, bucketName string) (s1 string, o1 minio.ObjectInfo, err error)
	inspectFuncUploadToMinio   func(ctx context.Context, objectName string, data []byte, contentType string, bucketName string)
	afterUploadToMinioCounter  uint64
	beforeUploadToMinioCounter uint64
	UploadToMinioMock          mRepositoryMockUploadToMinio
...
func NewRepositoryMock(t minimock.Tester) *RepositoryMock {
	...
	m.CreateOrUpdateComponentRunMock = mRepositoryMockCreateOrUpdateComponentRun{mock: m}
	m.CreateOrUpdateComponentRunMock.callArgs = []*RepositoryMockCreateOrUpdateComponentRunParams{}

	m.CreateOrUpdatePipelineRunMock = mRepositoryMockCreateOrUpdatePipelineRun{mock: m}
	m.CreateOrUpdatePipelineRunMock.callArgs = []*RepositoryMockCreateOrUpdatePipelineRunParams{}
	...
	m.GeneratePresignedURLMock = mRepositoryMockGeneratePresignedURL{mock: m}
	m.GeneratePresignedURLMock.callArgs = []*RepositoryMockGeneratePresignedURLParams{}
	...
	m.UploadToMinioMock = mRepositoryMockUploadToMinio{mock: m}
	m.UploadToMinioMock.callArgs = []*RepositoryMockUploadToMinioParams{}
...
type mRepositoryMockCreateOrUpdateComponentRun struct {
	optional           bool
	mock               *RepositoryMock
	defaultExpectation *RepositoryMockCreateOrUpdateComponentRunExpectation
	expectations       []*RepositoryMockCreateOrUpdateComponentRunExpectation

	callArgs []*RepositoryMockCreateOrUpdateComponentRunParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryMockCreateOrUpdateComponentRunExpectation specifies expectation struct of the Repository.CreateOrUpdateComponentRun
type RepositoryMockCreateOrUpdateComponentRunExpectation struct {
	mock      *RepositoryMock
	params    *RepositoryMockCreateOrUpdateComponentRunParams
	paramPtrs *RepositoryMockCreateOrUpdateComponentRunParamPtrs
	results   *RepositoryMockCreateOrUpdateComponentRunResults
	Counter   uint64
}

// RepositoryMockCreateOrUpdateComponentRunParams contains parameters of the Repository.CreateOrUpdateComponentRun
type RepositoryMockCreateOrUpdateComponentRunParams struct {
	ctx          context.Context
	componentRun *datamodel.ComponentRun
}

// RepositoryMockCreateOrUpdateComponentRunParamPtrs contains pointers to parameters of the Repository.CreateOrUpdateComponentRun
type RepositoryMockCreateOrUpdateComponentRunParamPtrs struct {
	ctx          *context.Context
	componentRun **datamodel.ComponentRun
}

// RepositoryMockCreateOrUpdateComponentRunResults contains results of the Repository.CreateOrUpdateComponentRun
type RepositoryMockCreateOrUpdateComponentRunResults struct {
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Optional() *mRepositoryMockCreateOrUpdateComponentRun {
	mmCreateOrUpdateComponentRun.optional = true
	return mmCreateOrUpdateComponentRun
}

// Expect sets up expected params for Repository.CreateOrUpdateComponentRun
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Expect(ctx context.Context, componentRun *datamodel.ComponentRun) *mRepositoryMockCreateOrUpdateComponentRun {
	if mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by Set")
	}

	if mmCreateOrUpdateComponentRun.defaultExpectation == nil {
		mmCreateOrUpdateComponentRun.defaultExpectation = &RepositoryMockCreateOrUpdateComponentRunExpectation{}
	}

	if mmCreateOrUpdateComponentRun.defaultExpectation.paramPtrs != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by ExpectParams functions")
	}

	mmCreateOrUpdateComponentRun.defaultExpectation.params = &RepositoryMockCreateOrUpdateComponentRunParams{ctx, componentRun}
	for _, e := range mmCreateOrUpdateComponentRun.expectations {
		if minimock.Equal(e.params, mmCreateOrUpdateComponentRun.defaultExpectation.params) {
			mmCreateOrUpdateComponentRun.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmCreateOrUpdateComponentRun.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for Repository.CreateOrUpdateComponentRun
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) ExpectCtxParam1(ctx context.Context) *mRepositoryMockCreateOrUpdateComponentRun {
	if mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by Set")
	}
	...
	if mmCreateOrUpdateComponentRun.defaultExpectation.params != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by Expect")
	}

	if mmCreateOrUpdateComponentRun.defaultExpectation.paramPtrs == nil {
		mmCreateOrUpdateComponentRun.defaultExpectation.paramPtrs = &RepositoryMockCreateOrUpdateComponentRunParamPtrs{}
	}
	mmCreateOrUpdateComponentRun.defaultExpectation.paramPtrs.ctx = &ctx

	return mmCreateOrUpdateComponentRun
}

// ExpectComponentRunParam2 sets up expected param componentRun for Repository.CreateOrUpdateComponentRun
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) ExpectComponentRunParam2(componentRun *datamodel.ComponentRun) *mRepositoryMockCreateOrUpdateComponentRun {
	if mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by Set")
	}
	...
	mmCreateOrUpdateComponentRun.defaultExpectation.paramPtrs.componentRun = &componentRun

	return mmCreateOrUpdateComponentRun
}

// Inspect accepts an inspector function that has same arguments as the Repository.CreateOrUpdateComponentRun
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Inspect(f func(ctx context.Context, componentRun *datamodel.ComponentRun)) *mRepositoryMockCreateOrUpdateComponentRun {
	if mmCreateOrUpdateComponentRun.mock.inspectFuncCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("Inspect function is already set for RepositoryMock.CreateOrUpdateComponentRun")
	}

	mmCreateOrUpdateComponentRun.mock.inspectFuncCreateOrUpdateComponentRun = f

	return mmCreateOrUpdateComponentRun
}

// Return sets up results that will be returned by Repository.CreateOrUpdateComponentRun
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Return(err error) *RepositoryMock {
	if mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by Set")
	}

	if mmCreateOrUpdateComponentRun.defaultExpectation == nil {
		mmCreateOrUpdateComponentRun.defaultExpectation = &RepositoryMockCreateOrUpdateComponentRunExpectation{mock: mmCreateOrUpdateComponentRun.mock}
	}
	mmCreateOrUpdateComponentRun.defaultExpectation.results = &RepositoryMockCreateOrUpdateComponentRunResults{err}
	return mmCreateOrUpdateComponentRun.mock
}

// Set uses given function f to mock the Repository.CreateOrUpdateComponentRun method
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Set(f func(ctx context.Context, componentRun *datamodel.ComponentRun) (err error)) *RepositoryMock {
	if mmCreateOrUpdateComponentRun.defaultExpectation != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("Default expectation is already set for the Repository.CreateOrUpdateComponentRun method")
	}

	if len(mmCreateOrUpdateComponentRun.expectations) > 0 {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("Some expectations are already set for the Repository.CreateOrUpdateComponentRun method")
	}

	mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun = f
	return mmCreateOrUpdateComponentRun.mock
}

// When sets expectation for the Repository.CreateOrUpdateComponentRun which will trigger the result defined by the following
// Then helper
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) When(ctx context.Context, componentRun *datamodel.ComponentRun) *RepositoryMockCreateOrUpdateComponentRunExpectation {
	if mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdateComponentRun mock is already set by Set")
	}

	expectation := &RepositoryMockCreateOrUpdateComponentRunExpectation{
		mock:   mmCreateOrUpdateComponentRun.mock,
		params: &RepositoryMockCreateOrUpdateComponentRunParams{ctx, componentRun},
	}
	mmCreateOrUpdateComponentRun.expectations = append(mmCreateOrUpdateComponentRun.expectations, expectation)
	return expectation
}

// Then sets up Repository.CreateOrUpdateComponentRun return parameters for the expectation previously defined by the When method
func (e *RepositoryMockCreateOrUpdateComponentRunExpectation) Then(err error) *RepositoryMock {
	e.results = &RepositoryMockCreateOrUpdateComponentRunResults{err}
	return e.mock
}

// Times sets number of times Repository.CreateOrUpdateComponentRun should be invoked
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Times(n uint64) *mRepositoryMockCreateOrUpdateComponentRun {
	if n == 0 {
		mmCreateOrUpdateComponentRun.mock.t.Fatalf("Times of RepositoryMock.CreateOrUpdateComponentRun mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmCreateOrUpdateComponentRun.expectedInvocations, n)
	return mmCreateOrUpdateComponentRun
}

func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) invocationsDone() bool {
	if len(mmCreateOrUpdateComponentRun.expectations) == 0 && mmCreateOrUpdateComponentRun.defaultExpectation == nil && mmCreateOrUpdateComponentRun.mock.funcCreateOrUpdateComponentRun == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmCreateOrUpdateComponentRun.mock.afterCreateOrUpdateComponentRunCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmCreateOrUpdateComponentRun.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// CreateOrUpdateComponentRun implements repository.Repository
func (mmCreateOrUpdateComponentRun *RepositoryMock) CreateOrUpdateComponentRun(ctx context.Context, componentRun *datamodel.ComponentRun) (err error) {
	mm_atomic.AddUint64(&mmCreateOrUpdateComponentRun.beforeCreateOrUpdateComponentRunCounter, 1)
	defer mm_atomic.AddUint64(&mmCreateOrUpdateComponentRun.afterCreateOrUpdateComponentRunCounter, 1)

	if mmCreateOrUpdateComponentRun.inspectFuncCreateOrUpdateComponentRun != nil {
		mmCreateOrUpdateComponentRun.inspectFuncCreateOrUpdateComponentRun(ctx, componentRun)
	}

	mm_params := RepositoryMockCreateOrUpdateComponentRunParams{ctx, componentRun}

	// Record call args
	mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.mutex.Lock()
	mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.callArgs = append(mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.callArgs, &mm_params)
	mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.mutex.Unlock()

	for _, e := range mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.err
		}
	...
	if mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.defaultExpectation.Counter, 1)
		mm_want := mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.defaultExpectation.params
		mm_want_ptrs := mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.defaultExpectation.paramPtrs

		mm_got := RepositoryMockCreateOrUpdateComponentRunParams{ctx, componentRun}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreateOrUpdateComponentRun.t.Errorf("RepositoryMock.CreateOrUpdateComponentRun got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.componentRun != nil && !minimock.Equal(*mm_want_ptrs.componentRun, mm_got.componentRun) {
				mmCreateOrUpdateComponentRun.t.Errorf("RepositoryMock.CreateOrUpdateComponentRun got unexpected parameter componentRun, want: %#v, got: %#v%s\n", *mm_want_ptrs.componentRun, mm_got.componentRun, minimock.Diff(*mm_want_ptrs.componentRun, mm_got.componentRun))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCreateOrUpdateComponentRun.t.Errorf("RepositoryMock.CreateOrUpdateComponentRun got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmCreateOrUpdateComponentRun.CreateOrUpdateComponentRunMock.defaultExpectation.results
		if mm_results == nil {
			mmCreateOrUpdateComponentRun.t.Fatal("No results are set for the RepositoryMock.CreateOrUpdateComponentRun")
		}
		return (*mm_results).err
	}
	if mmCreateOrUpdateComponentRun.funcCreateOrUpdateComponentRun != nil {
		return mmCreateOrUpdateComponentRun.funcCreateOrUpdateComponentRun(ctx, componentRun)
	}
	mmCreateOrUpdateComponentRun.t.Fatalf("Unexpected call to RepositoryMock.CreateOrUpdateComponentRun. %v %v", ctx, componentRun)
	return
}

// CreateOrUpdateComponentRunAfterCounter returns a count of finished RepositoryMock.CreateOrUpdateComponentRun invocations
func (mmCreateOrUpdateComponentRun *RepositoryMock) CreateOrUpdateComponentRunAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmCreateOrUpdateComponentRun.afterCreateOrUpdateComponentRunCounter)
}

// CreateOrUpdateComponentRunBeforeCounter returns a count of RepositoryMock.CreateOrUpdateComponentRun invocations
func (mmCreateOrUpdateComponentRun *RepositoryMock) CreateOrUpdateComponentRunBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmCreateOrUpdateComponentRun.beforeCreateOrUpdateComponentRunCounter)
}

// Calls returns a list of arguments used in each call to RepositoryMock.CreateOrUpdateComponentRun.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmCreateOrUpdateComponentRun *mRepositoryMockCreateOrUpdateComponentRun) Calls() []*RepositoryMockCreateOrUpdateComponentRunParams {
	mmCreateOrUpdateComponentRun.mutex.RLock()

	argCopy := make([]*RepositoryMockCreateOrUpdateComponentRunParams, len(mmCreateOrUpdateComponentRun.callArgs))
	copy(argCopy, mmCreateOrUpdateComponentRun.callArgs)

	mmCreateOrUpdateComponentRun.mutex.RUnlock()

	return argCopy
}

// MinimockCreateOrUpdateComponentRunDone returns true if the count of the CreateOrUpdateComponentRun invocations corresponds
// the number of defined expectations
func (m *RepositoryMock) MinimockCreateOrUpdateComponentRunDone() bool {
	if m.CreateOrUpdateComponentRunMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.CreateOrUpdateComponentRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.CreateOrUpdateComponentRunMock.invocationsDone()
}

// MinimockCreateOrUpdateComponentRunInspect logs each unmet expectation
func (m *RepositoryMock) MinimockCreateOrUpdateComponentRunInspect() {
	for _, e := range m.CreateOrUpdateComponentRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.CreateOrUpdateComponentRun with params: %#v", *e.params)
		}
	}

	afterCreateOrUpdateComponentRunCounter := mm_atomic.LoadUint64(&m.afterCreateOrUpdateComponentRunCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.CreateOrUpdateComponentRunMock.defaultExpectation != nil && afterCreateOrUpdateComponentRunCounter < 1 {
		if m.CreateOrUpdateComponentRunMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.CreateOrUpdateComponentRun")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.CreateOrUpdateComponentRun with params: %#v", *m.CreateOrUpdateComponentRunMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcCreateOrUpdateComponentRun != nil && afterCreateOrUpdateComponentRunCounter < 1 {
		m.t.Error("Expected call to RepositoryMock.CreateOrUpdateComponentRun")
	}

	if !m.CreateOrUpdateComponentRunMock.invocationsDone() && afterCreateOrUpdateComponentRunCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.CreateOrUpdateComponentRun but found %d calls",
			mm_atomic.LoadUint64(&m.CreateOrUpdateComponentRunMock.expectedInvocations), afterCreateOrUpdateComponentRunCounter)
	}
}

type mRepositoryMockCreateOrUpdatePipelineRun struct {
	optional           bool
	mock               *RepositoryMock
	defaultExpectation *RepositoryMockCreateOrUpdatePipelineRunExpectation
	expectations       []*RepositoryMockCreateOrUpdatePipelineRunExpectation

	callArgs []*RepositoryMockCreateOrUpdatePipelineRunParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryMockCreateOrUpdatePipelineRunExpectation specifies expectation struct of the Repository.CreateOrUpdatePipelineRun
type RepositoryMockCreateOrUpdatePipelineRunExpectation struct {
	mock      *RepositoryMock
	params    *RepositoryMockCreateOrUpdatePipelineRunParams
	paramPtrs *RepositoryMockCreateOrUpdatePipelineRunParamPtrs
	results   *RepositoryMockCreateOrUpdatePipelineRunResults
	Counter   uint64
}

// RepositoryMockCreateOrUpdatePipelineRunParams contains parameters of the Repository.CreateOrUpdatePipelineRun
type RepositoryMockCreateOrUpdatePipelineRunParams struct {
	ctx         context.Context
	pipelineRun *datamodel.PipelineRun
}

// RepositoryMockCreateOrUpdatePipelineRunParamPtrs contains pointers to parameters of the Repository.CreateOrUpdatePipelineRun
type RepositoryMockCreateOrUpdatePipelineRunParamPtrs struct {
	ctx         *context.Context
	pipelineRun **datamodel.PipelineRun
}

// RepositoryMockCreateOrUpdatePipelineRunResults contains results of the Repository.CreateOrUpdatePipelineRun
type RepositoryMockCreateOrUpdatePipelineRunResults struct {
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Optional() *mRepositoryMockCreateOrUpdatePipelineRun {
	mmCreateOrUpdatePipelineRun.optional = true
	return mmCreateOrUpdatePipelineRun
}

// Expect sets up expected params for Repository.CreateOrUpdatePipelineRun
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Expect(ctx context.Context, pipelineRun *datamodel.PipelineRun) *mRepositoryMockCreateOrUpdatePipelineRun {
	if mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by Set")
	}

	if mmCreateOrUpdatePipelineRun.defaultExpectation == nil {
		mmCreateOrUpdatePipelineRun.defaultExpectation = &RepositoryMockCreateOrUpdatePipelineRunExpectation{}
	}

	if mmCreateOrUpdatePipelineRun.defaultExpectation.paramPtrs != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by ExpectParams functions")
	}

	mmCreateOrUpdatePipelineRun.defaultExpectation.params = &RepositoryMockCreateOrUpdatePipelineRunParams{ctx, pipelineRun}
	for _, e := range mmCreateOrUpdatePipelineRun.expectations {
		if minimock.Equal(e.params, mmCreateOrUpdatePipelineRun.defaultExpectation.params) {
			mmCreateOrUpdatePipelineRun.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmCreateOrUpdatePipelineRun.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for Repository.CreateOrUpdatePipelineRun
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) ExpectCtxParam1(ctx context.Context) *mRepositoryMockCreateOrUpdatePipelineRun {
	if mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by Set")
	}
	...
	if mmCreateOrUpdatePipelineRun.defaultExpectation.params != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by Expect")
	}

	if mmCreateOrUpdatePipelineRun.defaultExpectation.paramPtrs == nil {
		mmCreateOrUpdatePipelineRun.defaultExpectation.paramPtrs = &RepositoryMockCreateOrUpdatePipelineRunParamPtrs{}
	}
	mmCreateOrUpdatePipelineRun.defaultExpectation.paramPtrs.ctx = &ctx

	return mmCreateOrUpdatePipelineRun
}

// ExpectPipelineRunParam2 sets up expected param pipelineRun for Repository.CreateOrUpdatePipelineRun
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) ExpectPipelineRunParam2(pipelineRun *datamodel.PipelineRun) *mRepositoryMockCreateOrUpdatePipelineRun {
	if mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by Set")
	}
	...
	mmCreateOrUpdatePipelineRun.defaultExpectation.paramPtrs.pipelineRun = &pipelineRun

	return mmCreateOrUpdatePipelineRun
}

// Inspect accepts an inspector function that has same arguments as the Repository.CreateOrUpdatePipelineRun
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Inspect(f func(ctx context.Context, pipelineRun *datamodel.PipelineRun)) *mRepositoryMockCreateOrUpdatePipelineRun {
	if mmCreateOrUpdatePipelineRun.mock.inspectFuncCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("Inspect function is already set for RepositoryMock.CreateOrUpdatePipelineRun")
	}

	mmCreateOrUpdatePipelineRun.mock.inspectFuncCreateOrUpdatePipelineRun = f

	return mmCreateOrUpdatePipelineRun
}

// Return sets up results that will be returned by Repository.CreateOrUpdatePipelineRun
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Return(err error) *RepositoryMock {
	if mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by Set")
	}

	if mmCreateOrUpdatePipelineRun.defaultExpectation == nil {
		mmCreateOrUpdatePipelineRun.defaultExpectation = &RepositoryMockCreateOrUpdatePipelineRunExpectation{mock: mmCreateOrUpdatePipelineRun.mock}
	}
	mmCreateOrUpdatePipelineRun.defaultExpectation.results = &RepositoryMockCreateOrUpdatePipelineRunResults{err}
	return mmCreateOrUpdatePipelineRun.mock
}

// Set uses given function f to mock the Repository.CreateOrUpdatePipelineRun method
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Set(f func(ctx context.Context, pipelineRun *datamodel.PipelineRun) (err error)) *RepositoryMock {
	if mmCreateOrUpdatePipelineRun.defaultExpectation != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("Default expectation is already set for the Repository.CreateOrUpdatePipelineRun method")
	}

	if len(mmCreateOrUpdatePipelineRun.expectations) > 0 {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("Some expectations are already set for the Repository.CreateOrUpdatePipelineRun method")
	}

	mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun = f
	return mmCreateOrUpdatePipelineRun.mock
}

// When sets expectation for the Repository.CreateOrUpdatePipelineRun which will trigger the result defined by the following
// Then helper
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) When(ctx context.Context, pipelineRun *datamodel.PipelineRun) *RepositoryMockCreateOrUpdatePipelineRunExpectation {
	if mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("RepositoryMock.CreateOrUpdatePipelineRun mock is already set by Set")
	}

	expectation := &RepositoryMockCreateOrUpdatePipelineRunExpectation{
		mock:   mmCreateOrUpdatePipelineRun.mock,
		params: &RepositoryMockCreateOrUpdatePipelineRunParams{ctx, pipelineRun},
	}
	mmCreateOrUpdatePipelineRun.expectations = append(mmCreateOrUpdatePipelineRun.expectations, expectation)
	return expectation
}

// Then sets up Repository.CreateOrUpdatePipelineRun return parameters for the expectation previously defined by the When method
func (e *RepositoryMockCreateOrUpdatePipelineRunExpectation) Then(err error) *RepositoryMock {
	e.results = &RepositoryMockCreateOrUpdatePipelineRunResults{err}
	return e.mock
}

// Times sets number of times Repository.CreateOrUpdatePipelineRun should be invoked
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Times(n uint64) *mRepositoryMockCreateOrUpdatePipelineRun {
	if n == 0 {
		mmCreateOrUpdatePipelineRun.mock.t.Fatalf("Times of RepositoryMock.CreateOrUpdatePipelineRun mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmCreateOrUpdatePipelineRun.expectedInvocations, n)
	return mmCreateOrUpdatePipelineRun
}

func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) invocationsDone() bool {
	if len(mmCreateOrUpdatePipelineRun.expectations) == 0 && mmCreateOrUpdatePipelineRun.defaultExpectation == nil && mmCreateOrUpdatePipelineRun.mock.funcCreateOrUpdatePipelineRun == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmCreateOrUpdatePipelineRun.mock.afterCreateOrUpdatePipelineRunCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmCreateOrUpdatePipelineRun.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// CreateOrUpdatePipelineRun implements repository.Repository
func (mmCreateOrUpdatePipelineRun *RepositoryMock) CreateOrUpdatePipelineRun(ctx context.Context, pipelineRun *datamodel.PipelineRun) (err error) {
	mm_atomic.AddUint64(&mmCreateOrUpdatePipelineRun.beforeCreateOrUpdatePipelineRunCounter, 1)
	defer mm_atomic.AddUint64(&mmCreateOrUpdatePipelineRun.afterCreateOrUpdatePipelineRunCounter, 1)

	if mmCreateOrUpdatePipelineRun.inspectFuncCreateOrUpdatePipelineRun != nil {
		mmCreateOrUpdatePipelineRun.inspectFuncCreateOrUpdatePipelineRun(ctx, pipelineRun)
	}

	mm_params := RepositoryMockCreateOrUpdatePipelineRunParams{ctx, pipelineRun}

	// Record call args
	mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.mutex.Lock()
	mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.callArgs = append(mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.callArgs, &mm_params)
	mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.mutex.Unlock()

	for _, e := range mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.err
		}
	...
	if mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.defaultExpectation.Counter, 1)
		mm_want := mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.defaultExpectation.params
		mm_want_ptrs := mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.defaultExpectation.paramPtrs

		mm_got := RepositoryMockCreateOrUpdatePipelineRunParams{ctx, pipelineRun}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreateOrUpdatePipelineRun.t.Errorf("RepositoryMock.CreateOrUpdatePipelineRun got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.pipelineRun != nil && !minimock.Equal(*mm_want_ptrs.pipelineRun, mm_got.pipelineRun) {
				mmCreateOrUpdatePipelineRun.t.Errorf("RepositoryMock.CreateOrUpdatePipelineRun got unexpected parameter pipelineRun, want: %#v, got: %#v%s\n", *mm_want_ptrs.pipelineRun, mm_got.pipelineRun, minimock.Diff(*mm_want_ptrs.pipelineRun, mm_got.pipelineRun))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCreateOrUpdatePipelineRun.t.Errorf("RepositoryMock.CreateOrUpdatePipelineRun got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmCreateOrUpdatePipelineRun.CreateOrUpdatePipelineRunMock.defaultExpectation.results
		if mm_results == nil {
			mmCreateOrUpdatePipelineRun.t.Fatal("No results are set for the RepositoryMock.CreateOrUpdatePipelineRun")
		}
		return (*mm_results).err
	}
	if mmCreateOrUpdatePipelineRun.funcCreateOrUpdatePipelineRun != nil {
		return mmCreateOrUpdatePipelineRun.funcCreateOrUpdatePipelineRun(ctx, pipelineRun)
	}
	mmCreateOrUpdatePipelineRun.t.Fatalf("Unexpected call to RepositoryMock.CreateOrUpdatePipelineRun. %v %v", ctx, pipelineRun)
	return
}

// CreateOrUpdatePipelineRunAfterCounter returns a count of finished RepositoryMock.CreateOrUpdatePipelineRun invocations
func (mmCreateOrUpdatePipelineRun *RepositoryMock) CreateOrUpdatePipelineRunAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmCreateOrUpdatePipelineRun.afterCreateOrUpdatePipelineRunCounter)
}

// CreateOrUpdatePipelineRunBeforeCounter returns a count of RepositoryMock.CreateOrUpdatePipelineRun invocations
func (mmCreateOrUpdatePipelineRun *RepositoryMock) CreateOrUpdatePipelineRunBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmCreateOrUpdatePipelineRun.beforeCreateOrUpdatePipelineRunCounter)
}

// Calls returns a list of arguments used in each call to RepositoryMock.CreateOrUpdatePipelineRun.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmCreateOrUpdatePipelineRun *mRepositoryMockCreateOrUpdatePipelineRun) Calls() []*RepositoryMockCreateOrUpdatePipelineRunParams {
	mmCreateOrUpdatePipelineRun.mutex.RLock()

	argCopy := make([]*RepositoryMockCreateOrUpdatePipelineRunParams, len(mmCreateOrUpdatePipelineRun.callArgs))
	copy(argCopy, mmCreateOrUpdatePipelineRun.callArgs)

	mmCreateOrUpdatePipelineRun.mutex.RUnlock()

	return argCopy
}

// MinimockCreateOrUpdatePipelineRunDone returns true if the count of the CreateOrUpdatePipelineRun invocations corresponds
// the number of defined expectations
func (m *RepositoryMock) MinimockCreateOrUpdatePipelineRunDone() bool {
	if m.CreateOrUpdatePipelineRunMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.CreateOrUpdatePipelineRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.CreateOrUpdatePipelineRunMock.invocationsDone()
}

// MinimockCreateOrUpdatePipelineRunInspect logs each unmet expectation
func (m *RepositoryMock) MinimockCreateOrUpdatePipelineRunInspect() {
	for _, e := range m.CreateOrUpdatePipelineRunMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.CreateOrUpdatePipelineRun with params: %#v", *e.params)
		}
	}

	afterCreateOrUpdatePipelineRunCounter := mm_atomic.LoadUint64(&m.afterCreateOrUpdatePipelineRunCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.CreateOrUpdatePipelineRunMock.defaultExpectation != nil && afterCreateOrUpdatePipelineRunCounter < 1 {
		if m.CreateOrUpdatePipelineRunMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.CreateOrUpdatePipelineRun")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.CreateOrUpdatePipelineRun with params: %#v", *m.CreateOrUpdatePipelineRunMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcCreateOrUpdatePipelineRun != nil && afterCreateOrUpdatePipelineRunCounter < 1 {
		m.t.Error("Expected call to RepositoryMock.CreateOrUpdatePipelineRun")
	}

	if !m.CreateOrUpdatePipelineRunMock.invocationsDone() && afterCreateOrUpdatePipelineRunCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.CreateOrUpdatePipelineRun but found %d calls",
			mm_atomic.LoadUint64(&m.CreateOrUpdatePipelineRunMock.expectedInvocations), afterCreateOrUpdatePipelineRunCounter)
	}
}
...
type mRepositoryMockGeneratePresignedURL struct {
	optional           bool
	mock               *RepositoryMock
	defaultExpectation *RepositoryMockGeneratePresignedURLExpectation
	expectations       []*RepositoryMockGeneratePresignedURLExpectation

	callArgs []*RepositoryMockGeneratePresignedURLParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryMockGeneratePresignedURLExpectation specifies expectation struct of the Repository.GeneratePresignedURL
type RepositoryMockGeneratePresignedURLExpectation struct {
	mock      *RepositoryMock
	params    *RepositoryMockGeneratePresignedURLParams
	paramPtrs *RepositoryMockGeneratePresignedURLParamPtrs
	results   *RepositoryMockGeneratePresignedURLResults
	Counter   uint64
}

// RepositoryMockGeneratePresignedURLParams contains parameters of the Repository.GeneratePresignedURL
type RepositoryMockGeneratePresignedURLParams struct {
	ctx        context.Context
	bucketName string
	objectName string
}

// RepositoryMockGeneratePresignedURLParamPtrs contains pointers to parameters of the Repository.GeneratePresignedURL
type RepositoryMockGeneratePresignedURLParamPtrs struct {
	ctx        *context.Context
	bucketName *string
	objectName *string
}

// RepositoryMockGeneratePresignedURLResults contains results of the Repository.GeneratePresignedURL
type RepositoryMockGeneratePresignedURLResults struct {
	s1  string
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Optional() *mRepositoryMockGeneratePresignedURL {
	mmGeneratePresignedURL.optional = true
	return mmGeneratePresignedURL
}

// Expect sets up expected params for Repository.GeneratePresignedURL
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Expect(ctx context.Context, bucketName string, objectName string) *mRepositoryMockGeneratePresignedURL {
	if mmGeneratePresignedURL.mock.funcGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Set")
	}

	if mmGeneratePresignedURL.defaultExpectation == nil {
		mmGeneratePresignedURL.defaultExpectation = &RepositoryMockGeneratePresignedURLExpectation{}
	}

	if mmGeneratePresignedURL.defaultExpectation.paramPtrs != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by ExpectParams functions")
	}

	mmGeneratePresignedURL.defaultExpectation.params = &RepositoryMockGeneratePresignedURLParams{ctx, bucketName, objectName}
	for _, e := range mmGeneratePresignedURL.expectations {
		if minimock.Equal(e.params, mmGeneratePresignedURL.defaultExpectation.params) {
			mmGeneratePresignedURL.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmGeneratePresignedURL.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for Repository.GeneratePresignedURL
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) ExpectCtxParam1(ctx context.Context) *mRepositoryMockGeneratePresignedURL {
	if mmGeneratePresignedURL.mock.funcGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Set")
	}
	...
	if mmGeneratePresignedURL.defaultExpectation.params != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Expect")
	}

	if mmGeneratePresignedURL.defaultExpectation.paramPtrs == nil {
		mmGeneratePresignedURL.defaultExpectation.paramPtrs = &RepositoryMockGeneratePresignedURLParamPtrs{}
	}
	mmGeneratePresignedURL.defaultExpectation.paramPtrs.ctx = &ctx

	return mmGeneratePresignedURL
}

// ExpectBucketNameParam2 sets up expected param bucketName for Repository.GeneratePresignedURL
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) ExpectBucketNameParam2(bucketName string) *mRepositoryMockGeneratePresignedURL {
	if mmGeneratePresignedURL.mock.funcGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Set")
	}
	...
	mmGeneratePresignedURL.defaultExpectation.paramPtrs.bucketName = &bucketName

	return mmGeneratePresignedURL
}

// ExpectObjectNameParam3 sets up expected param objectName for Repository.GeneratePresignedURL
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) ExpectObjectNameParam3(objectName string) *mRepositoryMockGeneratePresignedURL {
	if mmGeneratePresignedURL.mock.funcGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Set")
	}
	...
	mmGeneratePresignedURL.defaultExpectation.paramPtrs.objectName = &objectName

	return mmGeneratePresignedURL
}

// Inspect accepts an inspector function that has same arguments as the Repository.GeneratePresignedURL
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Inspect(f func(ctx context.Context, bucketName string, objectName string)) *mRepositoryMockGeneratePresignedURL {
	if mmGeneratePresignedURL.mock.inspectFuncGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("Inspect function is already set for RepositoryMock.GeneratePresignedURL")
	}

	mmGeneratePresignedURL.mock.inspectFuncGeneratePresignedURL = f

	return mmGeneratePresignedURL
}

// Return sets up results that will be returned by Repository.GeneratePresignedURL
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Return(s1 string, err error) *RepositoryMock {
	if mmGeneratePresignedURL.mock.funcGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Set")
	}

	if mmGeneratePresignedURL.defaultExpectation == nil {
		mmGeneratePresignedURL.defaultExpectation = &RepositoryMockGeneratePresignedURLExpectation{mock: mmGeneratePresignedURL.mock}
	}
	mmGeneratePresignedURL.defaultExpectation.results = &RepositoryMockGeneratePresignedURLResults{s1, err}
	return mmGeneratePresignedURL.mock
}

// Set uses given function f to mock the Repository.GeneratePresignedURL method
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Set(f func(ctx context.Context, bucketName string, objectName string) (s1 string, err error)) *RepositoryMock {
	if mmGeneratePresignedURL.defaultExpectation != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("Default expectation is already set for the Repository.GeneratePresignedURL method")
	}

	if len(mmGeneratePresignedURL.expectations) > 0 {
		mmGeneratePresignedURL.mock.t.Fatalf("Some expectations are already set for the Repository.GeneratePresignedURL method")
	}

	mmGeneratePresignedURL.mock.funcGeneratePresignedURL = f
	return mmGeneratePresignedURL.mock
}

// When sets expectation for the Repository.GeneratePresignedURL which will trigger the result defined by the following
// Then helper
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) When(ctx context.Context, bucketName string, objectName string) *RepositoryMockGeneratePresignedURLExpectation {
	if mmGeneratePresignedURL.mock.funcGeneratePresignedURL != nil {
		mmGeneratePresignedURL.mock.t.Fatalf("RepositoryMock.GeneratePresignedURL mock is already set by Set")
	}

	expectation := &RepositoryMockGeneratePresignedURLExpectation{
		mock:   mmGeneratePresignedURL.mock,
		params: &RepositoryMockGeneratePresignedURLParams{ctx, bucketName, objectName},
	}
	mmGeneratePresignedURL.expectations = append(mmGeneratePresignedURL.expectations, expectation)
	return expectation
}

// Then sets up Repository.GeneratePresignedURL return parameters for the expectation previously defined by the When method
func (e *RepositoryMockGeneratePresignedURLExpectation) Then(s1 string, err error) *RepositoryMock {
	e.results = &RepositoryMockGeneratePresignedURLResults{s1, err}
	return e.mock
}

// Times sets number of times Repository.GeneratePresignedURL should be invoked
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Times(n uint64) *mRepositoryMockGeneratePresignedURL {
	if n == 0 {
		mmGeneratePresignedURL.mock.t.Fatalf("Times of RepositoryMock.GeneratePresignedURL mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmGeneratePresignedURL.expectedInvocations, n)
	return mmGeneratePresignedURL
}

func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) invocationsDone() bool {
	if len(mmGeneratePresignedURL.expectations) == 0 && mmGeneratePresignedURL.defaultExpectation == nil && mmGeneratePresignedURL.mock.funcGeneratePresignedURL == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmGeneratePresignedURL.mock.afterGeneratePresignedURLCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmGeneratePresignedURL.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// GeneratePresignedURL implements repository.Repository
func (mmGeneratePresignedURL *RepositoryMock) GeneratePresignedURL(ctx context.Context, bucketName string, objectName string) (s1 string, err error) {
	mm_atomic.AddUint64(&mmGeneratePresignedURL.beforeGeneratePresignedURLCounter, 1)
	defer mm_atomic.AddUint64(&mmGeneratePresignedURL.afterGeneratePresignedURLCounter, 1)

	if mmGeneratePresignedURL.inspectFuncGeneratePresignedURL != nil {
		mmGeneratePresignedURL.inspectFuncGeneratePresignedURL(ctx, bucketName, objectName)
	}

	mm_params := RepositoryMockGeneratePresignedURLParams{ctx, bucketName, objectName}

	// Record call args
	mmGeneratePresignedURL.GeneratePresignedURLMock.mutex.Lock()
	mmGeneratePresignedURL.GeneratePresignedURLMock.callArgs = append(mmGeneratePresignedURL.GeneratePresignedURLMock.callArgs, &mm_params)
	mmGeneratePresignedURL.GeneratePresignedURLMock.mutex.Unlock()

	for _, e := range mmGeneratePresignedURL.GeneratePresignedURLMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
	...
	if mmGeneratePresignedURL.GeneratePresignedURLMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmGeneratePresignedURL.GeneratePresignedURLMock.defaultExpectation.Counter, 1)
		mm_want := mmGeneratePresignedURL.GeneratePresignedURLMock.defaultExpectation.params
		mm_want_ptrs := mmGeneratePresignedURL.GeneratePresignedURLMock.defaultExpectation.paramPtrs

		mm_got := RepositoryMockGeneratePresignedURLParams{ctx, bucketName, objectName}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGeneratePresignedURL.t.Errorf("RepositoryMock.GeneratePresignedURL got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.bucketName != nil && !minimock.Equal(*mm_want_ptrs.bucketName, mm_got.bucketName) {
				mmGeneratePresignedURL.t.Errorf("RepositoryMock.GeneratePresignedURL got unexpected parameter bucketName, want: %#v, got: %#v%s\n", *mm_want_ptrs.bucketName, mm_got.bucketName, minimock.Diff(*mm_want_ptrs.bucketName, mm_got.bucketName))
			}

			if mm_want_ptrs.objectName != nil && !minimock.Equal(*mm_want_ptrs.objectName, mm_got.objectName) {
				mmGeneratePresignedURL.t.Errorf("RepositoryMock.GeneratePresignedURL got unexpected parameter objectName, want: %#v, got: %#v%s\n", *mm_want_ptrs.objectName, mm_got.objectName, minimock.Diff(*mm_want_ptrs.objectName, mm_got.objectName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGeneratePresignedURL.t.Errorf("RepositoryMock.GeneratePresignedURL got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmGeneratePresignedURL.GeneratePresignedURLMock.defaultExpectation.results
		if mm_results == nil {
			mmGeneratePresignedURL.t.Fatal("No results are set for the RepositoryMock.GeneratePresignedURL")
		}
		return (*mm_results).s1, (*mm_results).err
	}
	if mmGeneratePresignedURL.funcGeneratePresignedURL != nil {
		return mmGeneratePresignedURL.funcGeneratePresignedURL(ctx, bucketName, objectName)
	}
	mmGeneratePresignedURL.t.Fatalf("Unexpected call to RepositoryMock.GeneratePresignedURL. %v %v %v", ctx, bucketName, objectName)
	return
}

// GeneratePresignedURLAfterCounter returns a count of finished RepositoryMock.GeneratePresignedURL invocations
func (mmGeneratePresignedURL *RepositoryMock) GeneratePresignedURLAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGeneratePresignedURL.afterGeneratePresignedURLCounter)
}

// GeneratePresignedURLBeforeCounter returns a count of RepositoryMock.GeneratePresignedURL invocations
func (mmGeneratePresignedURL *RepositoryMock) GeneratePresignedURLBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGeneratePresignedURL.beforeGeneratePresignedURLCounter)
}

// Calls returns a list of arguments used in each call to RepositoryMock.GeneratePresignedURL.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGeneratePresignedURL *mRepositoryMockGeneratePresignedURL) Calls() []*RepositoryMockGeneratePresignedURLParams {
	mmGeneratePresignedURL.mutex.RLock()

	argCopy := make([]*RepositoryMockGeneratePresignedURLParams, len(mmGeneratePresignedURL.callArgs))
	copy(argCopy, mmGeneratePresignedURL.callArgs)

	mmGeneratePresignedURL.mutex.RUnlock()

	return argCopy
}

// MinimockGeneratePresignedURLDone returns true if the count of the GeneratePresignedURL invocations corresponds
// the number of defined expectations
func (m *RepositoryMock) MinimockGeneratePresignedURLDone() bool {
	if m.GeneratePresignedURLMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.GeneratePresignedURLMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.GeneratePresignedURLMock.invocationsDone()
}

// MinimockGeneratePresignedURLInspect logs each unmet expectation
func (m *RepositoryMock) MinimockGeneratePresignedURLInspect() {
	for _, e := range m.GeneratePresignedURLMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.GeneratePresignedURL with params: %#v", *e.params)
		}
	}

	afterGeneratePresignedURLCounter := mm_atomic.LoadUint64(&m.afterGeneratePresignedURLCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.GeneratePresignedURLMock.defaultExpectation != nil && afterGeneratePresignedURLCounter < 1 {
		if m.GeneratePresignedURLMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.GeneratePresignedURL")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.GeneratePresignedURL with params: %#v", *m.GeneratePresignedURLMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcGeneratePresignedURL != nil && afterGeneratePresignedURLCounter < 1 {
		m.t.Error("Expected call to RepositoryMock.GeneratePresignedURL")
	}

	if !m.GeneratePresignedURLMock.invocationsDone() && afterGeneratePresignedURLCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.GeneratePresignedURL but found %d calls",
			mm_atomic.LoadUint64(&m.GeneratePresignedURLMock.expectedInvocations), afterGeneratePresignedURLCounter)
	}
}
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) Expect(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	...
	mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.defaultExpectation.params = &RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize}
...
// ExpectUserIDParam2 sets up expected param userID for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectUserIDParam2(userID string) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
	...
	mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.defaultExpectation.paramPtrs.userID = &userID

	return mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions
}

// ExpectPipelineRunIDParam3 sets up expected param pipelineRunID for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectPipelineRunIDParam3(pipelineRunID string) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
...
// ExpectPageParam4 sets up expected param page for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectPageParam4(page int) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
...
// ExpectPageSizeParam5 sets up expected param pageSize for Repository.GetPaginatedComponentRunsByPipelineRunIDWithPermissions
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) ExpectPageSizeParam5(pageSize int) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) Inspect(f func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int)) *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions {
...
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) Set(f func(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int) (ca1 []datamodel.ComponentRun, i1 int64, err error)) *RepositoryMock {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.defaultExpectation != nil {
...
// Then helper
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *mRepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissions) When(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int) *RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsExpectation {
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions mock is already set by Set")
	}
	...
	expectation := &RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsExpectation{
		...
		params: &RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize},
	}
...
// GetPaginatedComponentRunsByPipelineRunIDWithPermissions implements repository.Repository
func (mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions *RepositoryMock) GetPaginatedComponentRunsByPipelineRunIDWithPermissions(ctx context.Context, userID string, pipelineRunID string, page int, pageSize int) (ca1 []datamodel.ComponentRun, i1 int64, err error) {
	...
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.inspectFuncGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.inspectFuncGetPaginatedComponentRunsByPipelineRunIDWithPermissions(ctx, userID, pipelineRunID, page, pageSize)
	}

	mm_params := RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize}
	...
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsParams{ctx, userID, pipelineRunID, page, pageSize}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter userID, want: %#v, got: %#v%s\n", *mm_want_ptrs.userID, mm_got.userID, minimock.Diff(*mm_want_ptrs.userID, mm_got.userID))
			}

			if mm_want_ptrs.pipelineRunID != nil && !minimock.Equal(*mm_want_ptrs.pipelineRunID, mm_got.pipelineRunID) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter pipelineRunID, want: %#v, got: %#v%s\n", *mm_want_ptrs.pipelineRunID, mm_got.pipelineRunID, minimock.Diff(*mm_want_ptrs.pipelineRunID, mm_got.pipelineRunID))
			}

			if mm_want_ptrs.page != nil && !minimock.Equal(*mm_want_ptrs.page, mm_got.page) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter page, want: %#v, got: %#v%s\n", *mm_want_ptrs.page, mm_got.page, minimock.Diff(*mm_want_ptrs.page, mm_got.page))
			}

			if mm_want_ptrs.pageSize != nil && !minimock.Equal(*mm_want_ptrs.pageSize, mm_got.pageSize) {
				mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameter pageSize, want: %#v, got: %#v%s\n", *mm_want_ptrs.pageSize, mm_got.pageSize, minimock.Diff(*mm_want_ptrs.pageSize, mm_got.pageSize))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Errorf("RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
	...
	if mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions != nil {
		return mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.funcGetPaginatedComponentRunsByPipelineRunIDWithPermissions(ctx, userID, pipelineRunID, page, pageSize)
	}
	mmGetPaginatedComponentRunsByPipelineRunIDWithPermissions.t.Fatalf("Unexpected call to RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions. %v %v %v %v %v", ctx, userID, pipelineRunID, page, pageSize)
	return
}
...
func (m *RepositoryMock) MinimockGetPaginatedComponentRunsByPipelineRunIDWithPermissionsInspect() {
	for _, e := range m.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions with params: %#v", *e.params)
		}
	}
	...
	if m.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.defaultExpectation != nil && afterGetPaginatedComponentRunsByPipelineRunIDWithPermissionsCounter < 1 {
		if m.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions with params: %#v", *m.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.invocationsDone() && afterGetPaginatedComponentRunsByPipelineRunIDWithPermissionsCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.GetPaginatedComponentRunsByPipelineRunIDWithPermissions but found %d calls",
			mm_atomic.LoadUint64(&m.GetPaginatedComponentRunsByPipelineRunIDWithPermissionsMock.expectedInvocations), afterGetPaginatedComponentRunsByPipelineRunIDWithPermissionsCounter)
	}
}
...
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) Expect(ctx context.Context, userID string, namespace string, page int, pageSize int) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
	...
	mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation.params = &RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, namespace, page, pageSize}
...
// ExpectUserIDParam2 sets up expected param userID for Repository.GetPaginatedPipelineRunsWithPermissions
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) ExpectUserIDParam2(userID string) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
	if mmGetPaginatedPipelineRunsWithPermissions.mock.funcGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions mock is already set by Set")
	}
	...
	mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation.paramPtrs.userID = &userID

	return mmGetPaginatedPipelineRunsWithPermissions
}

// ExpectNamespaceParam3 sets up expected param namespace for Repository.GetPaginatedPipelineRunsWithPermissions
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) ExpectNamespaceParam3(namespace string) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
	if mmGetPaginatedPipelineRunsWithPermissions.mock.funcGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions mock is already set by Set")
	}
	...
	mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation.paramPtrs.namespace = &namespace
...
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) Inspect(f func(ctx context.Context, userID string, namespace string, page int, pageSize int)) *mRepositoryMockGetPaginatedPipelineRunsWithPermissions {
...
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) Set(f func(ctx context.Context, userID string, namespace string, page int, pageSize int) (pa1 []datamodel.PipelineRun, i1 int64, err error)) *RepositoryMock {
	if mmGetPaginatedPipelineRunsWithPermissions.defaultExpectation != nil {
...
// Then helper
func (mmGetPaginatedPipelineRunsWithPermissions *mRepositoryMockGetPaginatedPipelineRunsWithPermissions) When(ctx context.Context, userID string, namespace string, page int, pageSize int) *RepositoryMockGetPaginatedPipelineRunsWithPermissionsExpectation {
	if mmGetPaginatedPipelineRunsWithPermissions.mock.funcGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.mock.t.Fatalf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions mock is already set by Set")
	}
	...
	expectation := &RepositoryMockGetPaginatedPipelineRunsWithPermissionsExpectation{
		...
		params: &RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, namespace, page, pageSize},
	}
...
func (mmGetPaginatedPipelineRunsWithPermissions *RepositoryMock) GetPaginatedPipelineRunsWithPermissions(ctx context.Context, userID string, namespace string, page int, pageSize int) (pa1 []datamodel.PipelineRun, i1 int64, err error) {
	...
	if mmGetPaginatedPipelineRunsWithPermissions.inspectFuncGetPaginatedPipelineRunsWithPermissions != nil {
		mmGetPaginatedPipelineRunsWithPermissions.inspectFuncGetPaginatedPipelineRunsWithPermissions(ctx, userID, namespace, page, pageSize)
	}

	mm_params := RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, namespace, page, pageSize}
	...
	if mmGetPaginatedPipelineRunsWithPermissions.GetPaginatedPipelineRunsWithPermissionsMock.defaultExpectation != nil {
		...
		mm_got := RepositoryMockGetPaginatedPipelineRunsWithPermissionsParams{ctx, userID, namespace, page, pageSize}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter userID, want: %#v, got: %#v%s\n", *mm_want_ptrs.userID, mm_got.userID, minimock.Diff(*mm_want_ptrs.userID, mm_got.userID))
			}

			if mm_want_ptrs.namespace != nil && !minimock.Equal(*mm_want_ptrs.namespace, mm_got.namespace) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter namespace, want: %#v, got: %#v%s\n", *mm_want_ptrs.namespace, mm_got.namespace, minimock.Diff(*mm_want_ptrs.namespace, mm_got.namespace))
			}

			if mm_want_ptrs.page != nil && !minimock.Equal(*mm_want_ptrs.page, mm_got.page) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter page, want: %#v, got: %#v%s\n", *mm_want_ptrs.page, mm_got.page, minimock.Diff(*mm_want_ptrs.page, mm_got.page))
			}

			if mm_want_ptrs.pageSize != nil && !minimock.Equal(*mm_want_ptrs.pageSize, mm_got.pageSize) {
				mmGetPaginatedPipelineRunsWithPermissions.t.Errorf("RepositoryMock.GetPaginatedPipelineRunsWithPermissions got unexpected parameter pageSize, want: %#v, got: %#v%s\n", *mm_want_ptrs.pageSize, mm_got.pageSize, minimock.Diff(*mm_want_ptrs.pageSize, mm_got.pageSize))
			}
	...
	if mmGetPaginatedPipelineRunsWithPermissions.funcGetPaginatedPipelineRunsWithPermissions != nil {
		return mmGetPaginatedPipelineRunsWithPermissions.funcGetPaginatedPipelineRunsWithPermissions(ctx, userID, namespace, page, pageSize)
	}
	mmGetPaginatedPipelineRunsWithPermissions.t.Fatalf("Unexpected call to RepositoryMock.GetPaginatedPipelineRunsWithPermissions. %v %v %v %v %v", ctx, userID, namespace, page, pageSize)
	return
}
...
func (m *RepositoryMock) MinimockGetPaginatedPipelineRunsWithPermissionsInspect() {
	for _, e := range m.GetPaginatedPipelineRunsWithPermissionsMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.GetPaginatedPipelineRunsWithPermissions with params: %#v", *e.params)
		}
	}
	...
	if m.GetPaginatedPipelineRunsWithPermissionsMock.defaultExpectation != nil && afterGetPaginatedPipelineRunsWithPermissionsCounter < 1 {
		if m.GetPaginatedPipelineRunsWithPermissionsMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.GetPaginatedPipelineRunsWithPermissions")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.GetPaginatedPipelineRunsWithPermissions with params: %#v", *m.GetPaginatedPipelineRunsWithPermissionsMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	...
	if !m.GetPaginatedPipelineRunsWithPermissionsMock.invocationsDone() && afterGetPaginatedPipelineRunsWithPermissionsCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.GetPaginatedPipelineRunsWithPermissions but found %d calls",
			mm_atomic.LoadUint64(&m.GetPaginatedPipelineRunsWithPermissionsMock.expectedInvocations), afterGetPaginatedPipelineRunsWithPermissionsCounter)
	}
}
...
type mRepositoryMockUploadToMinio struct {
	optional           bool
	mock               *RepositoryMock
	defaultExpectation *RepositoryMockUploadToMinioExpectation
	expectations       []*RepositoryMockUploadToMinioExpectation

	callArgs []*RepositoryMockUploadToMinioParams
	mutex    sync.RWMutex

	expectedInvocations uint64
}

// RepositoryMockUploadToMinioExpectation specifies expectation struct of the Repository.UploadToMinio
type RepositoryMockUploadToMinioExpectation struct {
	mock      *RepositoryMock
	params    *RepositoryMockUploadToMinioParams
	paramPtrs *RepositoryMockUploadToMinioParamPtrs
	results   *RepositoryMockUploadToMinioResults
	Counter   uint64
}

// RepositoryMockUploadToMinioParams contains parameters of the Repository.UploadToMinio
type RepositoryMockUploadToMinioParams struct {
	ctx         context.Context
	objectName  string
	data        []byte
	contentType string
...
// RepositoryMockUploadToMinioParamPtrs contains pointers to parameters of the Repository.UploadToMinio
type RepositoryMockUploadToMinioParamPtrs struct {
	ctx         *context.Context
	objectName  *string
	data        *[]byte
	contentType *string
...
// RepositoryMockUploadToMinioResults contains results of the Repository.UploadToMinio
type RepositoryMockUploadToMinioResults struct {
	s1  string
	o1  minio.ObjectInfo
	err error
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Optional() *mRepositoryMockUploadToMinio {
	mmUploadToMinio.optional = true
	return mmUploadToMinio
}

// Expect sets up expected params for Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Expect(ctx context.Context, objectName string, data []byte, contentType string, bucketName string) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}

	if mmUploadToMinio.defaultExpectation == nil {
		mmUploadToMinio.defaultExpectation = &RepositoryMockUploadToMinioExpectation{}
	}

	if mmUploadToMinio.defaultExpectation.paramPtrs != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by ExpectParams functions")
	}

	mmUploadToMinio.defaultExpectation.params = &RepositoryMockUploadToMinioParams{ctx, objectName, data, contentType, bucketName}
	for _, e := range mmUploadToMinio.expectations {
		if minimock.Equal(e.params, mmUploadToMinio.defaultExpectation.params) {
			mmUploadToMinio.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmUploadToMinio.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) ExpectCtxParam1(ctx context.Context) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}
	...
	if mmUploadToMinio.defaultExpectation.params != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Expect")
	}

	if mmUploadToMinio.defaultExpectation.paramPtrs == nil {
		mmUploadToMinio.defaultExpectation.paramPtrs = &RepositoryMockUploadToMinioParamPtrs{}
	}
	mmUploadToMinio.defaultExpectation.paramPtrs.ctx = &ctx

	return mmUploadToMinio
}

// ExpectObjectNameParam2 sets up expected param objectName for Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) ExpectObjectNameParam2(objectName string) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}
	...
	mmUploadToMinio.defaultExpectation.paramPtrs.objectName = &objectName

	return mmUploadToMinio
}

// ExpectDataParam3 sets up expected param data for Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) ExpectDataParam3(data []byte) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}
	...
	mmUploadToMinio.defaultExpectation.paramPtrs.data = &data

	return mmUploadToMinio
}

// ExpectContentTypeParam4 sets up expected param contentType for Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) ExpectContentTypeParam4(contentType string) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}
	...
	mmUploadToMinio.defaultExpectation.paramPtrs.contentType = &contentType

	return mmUploadToMinio
}

// ExpectBucketNameParam5 sets up expected param bucketName for Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) ExpectBucketNameParam5(bucketName string) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}
	...
	mmUploadToMinio.defaultExpectation.paramPtrs.bucketName = &bucketName

	return mmUploadToMinio
}

// Inspect accepts an inspector function that has same arguments as the Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Inspect(f func(ctx context.Context, objectName string, data []byte, contentType string, bucketName string)) *mRepositoryMockUploadToMinio {
	if mmUploadToMinio.mock.inspectFuncUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("Inspect function is already set for RepositoryMock.UploadToMinio")
	}

	mmUploadToMinio.mock.inspectFuncUploadToMinio = f

	return mmUploadToMinio
}

// Return sets up results that will be returned by Repository.UploadToMinio
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Return(s1 string, o1 minio.ObjectInfo, err error) *RepositoryMock {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}

	if mmUploadToMinio.defaultExpectation == nil {
		mmUploadToMinio.defaultExpectation = &RepositoryMockUploadToMinioExpectation{mock: mmUploadToMinio.mock}
	}
	mmUploadToMinio.defaultExpectation.results = &RepositoryMockUploadToMinioResults{s1, o1, err}
	return mmUploadToMinio.mock
}

// Set uses given function f to mock the Repository.UploadToMinio method
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Set(f func(ctx context.Context, objectName string, data []byte, contentType string, bucketName string) (s1 string, o1 minio.ObjectInfo, err error)) *RepositoryMock {
	if mmUploadToMinio.defaultExpectation != nil {
		mmUploadToMinio.mock.t.Fatalf("Default expectation is already set for the Repository.UploadToMinio method")
	}

	if len(mmUploadToMinio.expectations) > 0 {
		mmUploadToMinio.mock.t.Fatalf("Some expectations are already set for the Repository.UploadToMinio method")
	}

	mmUploadToMinio.mock.funcUploadToMinio = f
	return mmUploadToMinio.mock
}

// When sets expectation for the Repository.UploadToMinio which will trigger the result defined by the following
// Then helper
func (mmUploadToMinio *mRepositoryMockUploadToMinio) When(ctx context.Context, objectName string, data []byte, contentType string, bucketName string) *RepositoryMockUploadToMinioExpectation {
	if mmUploadToMinio.mock.funcUploadToMinio != nil {
		mmUploadToMinio.mock.t.Fatalf("RepositoryMock.UploadToMinio mock is already set by Set")
	}

	expectation := &RepositoryMockUploadToMinioExpectation{
		mock:   mmUploadToMinio.mock,
		params: &RepositoryMockUploadToMinioParams{ctx, objectName, data, contentType, bucketName},
	}
	mmUploadToMinio.expectations = append(mmUploadToMinio.expectations, expectation)
	return expectation
}

// Then sets up Repository.UploadToMinio return parameters for the expectation previously defined by the When method
func (e *RepositoryMockUploadToMinioExpectation) Then(s1 string, o1 minio.ObjectInfo, err error) *RepositoryMock {
	e.results = &RepositoryMockUploadToMinioResults{s1, o1, err}
	return e.mock
}

// Times sets number of times Repository.UploadToMinio should be invoked
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Times(n uint64) *mRepositoryMockUploadToMinio {
	if n == 0 {
		mmUploadToMinio.mock.t.Fatalf("Times of RepositoryMock.UploadToMinio mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmUploadToMinio.expectedInvocations, n)
	return mmUploadToMinio
}

func (mmUploadToMinio *mRepositoryMockUploadToMinio) invocationsDone() bool {
	if len(mmUploadToMinio.expectations) == 0 && mmUploadToMinio.defaultExpectation == nil && mmUploadToMinio.mock.funcUploadToMinio == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmUploadToMinio.mock.afterUploadToMinioCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmUploadToMinio.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// UploadToMinio implements repository.Repository
func (mmUploadToMinio *RepositoryMock) UploadToMinio(ctx context.Context, objectName string, data []byte, contentType string, bucketName string) (s1 string, o1 minio.ObjectInfo, err error) {
	mm_atomic.AddUint64(&mmUploadToMinio.beforeUploadToMinioCounter, 1)
	defer mm_atomic.AddUint64(&mmUploadToMinio.afterUploadToMinioCounter, 1)

	if mmUploadToMinio.inspectFuncUploadToMinio != nil {
		mmUploadToMinio.inspectFuncUploadToMinio(ctx, objectName, data, contentType, bucketName)
	}

	mm_params := RepositoryMockUploadToMinioParams{ctx, objectName, data, contentType, bucketName}

	// Record call args
	mmUploadToMinio.UploadToMinioMock.mutex.Lock()
	mmUploadToMinio.UploadToMinioMock.callArgs = append(mmUploadToMinio.UploadToMinioMock.callArgs, &mm_params)
	mmUploadToMinio.UploadToMinioMock.mutex.Unlock()

	for _, e := range mmUploadToMinio.UploadToMinioMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.s1, e.results.o1, e.results.err
		}
	}

	if mmUploadToMinio.UploadToMinioMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmUploadToMinio.UploadToMinioMock.defaultExpectation.Counter, 1)
		mm_want := mmUploadToMinio.UploadToMinioMock.defaultExpectation.params
		mm_want_ptrs := mmUploadToMinio.UploadToMinioMock.defaultExpectation.paramPtrs

		mm_got := RepositoryMockUploadToMinioParams{ctx, objectName, data, contentType, bucketName}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmUploadToMinio.t.Errorf("RepositoryMock.UploadToMinio got unexpected parameter ctx, want: %#v, got: %#v%s\n", *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.objectName != nil && !minimock.Equal(*mm_want_ptrs.objectName, mm_got.objectName) {
				mmUploadToMinio.t.Errorf("RepositoryMock.UploadToMinio got unexpected parameter objectName, want: %#v, got: %#v%s\n", *mm_want_ptrs.objectName, mm_got.objectName, minimock.Diff(*mm_want_ptrs.objectName, mm_got.objectName))
			}

			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmUploadToMinio.t.Errorf("RepositoryMock.UploadToMinio got unexpected parameter data, want: %#v, got: %#v%s\n", *mm_want_ptrs.data, mm_got.data, minimock.Diff(*mm_want_ptrs.data, mm_got.data))
			}

			if mm_want_ptrs.contentType != nil && !minimock.Equal(*mm_want_ptrs.contentType, mm_got.contentType) {
				mmUploadToMinio.t.Errorf("RepositoryMock.UploadToMinio got unexpected parameter contentType, want: %#v, got: %#v%s\n", *mm_want_ptrs.contentType, mm_got.contentType, minimock.Diff(*mm_want_ptrs.contentType, mm_got.contentType))
			}

			if mm_want_ptrs.bucketName != nil && !minimock.Equal(*mm_want_ptrs.bucketName, mm_got.bucketName) {
				mmUploadToMinio.t.Errorf("RepositoryMock.UploadToMinio got unexpected parameter bucketName, want: %#v, got: %#v%s\n", *mm_want_ptrs.bucketName, mm_got.bucketName, minimock.Diff(*mm_want_ptrs.bucketName, mm_got.bucketName))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmUploadToMinio.t.Errorf("RepositoryMock.UploadToMinio got unexpected parameters, want: %#v, got: %#v%s\n", *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmUploadToMinio.UploadToMinioMock.defaultExpectation.results
		if mm_results == nil {
			mmUploadToMinio.t.Fatal("No results are set for the RepositoryMock.UploadToMinio")
		}
		return (*mm_results).s1, (*mm_results).o1, (*mm_results).err
	}
	if mmUploadToMinio.funcUploadToMinio != nil {
		return mmUploadToMinio.funcUploadToMinio(ctx, objectName, data, contentType, bucketName)
	}
	mmUploadToMinio.t.Fatalf("Unexpected call to RepositoryMock.UploadToMinio. %v %v %v %v %v", ctx, objectName, data, contentType, bucketName)
	return
}

// UploadToMinioAfterCounter returns a count of finished RepositoryMock.UploadToMinio invocations
func (mmUploadToMinio *RepositoryMock) UploadToMinioAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmUploadToMinio.afterUploadToMinioCounter)
}

// UploadToMinioBeforeCounter returns a count of RepositoryMock.UploadToMinio invocations
func (mmUploadToMinio *RepositoryMock) UploadToMinioBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmUploadToMinio.beforeUploadToMinioCounter)
}

// Calls returns a list of arguments used in each call to RepositoryMock.UploadToMinio.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmUploadToMinio *mRepositoryMockUploadToMinio) Calls() []*RepositoryMockUploadToMinioParams {
	mmUploadToMinio.mutex.RLock()

	argCopy := make([]*RepositoryMockUploadToMinioParams, len(mmUploadToMinio.callArgs))
	copy(argCopy, mmUploadToMinio.callArgs)

	mmUploadToMinio.mutex.RUnlock()

	return argCopy
}

// MinimockUploadToMinioDone returns true if the count of the UploadToMinio invocations corresponds
// the number of defined expectations
func (m *RepositoryMock) MinimockUploadToMinioDone() bool {
	if m.UploadToMinioMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.UploadToMinioMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.UploadToMinioMock.invocationsDone()
}

// MinimockUploadToMinioInspect logs each unmet expectation
func (m *RepositoryMock) MinimockUploadToMinioInspect() {
	for _, e := range m.UploadToMinioMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to RepositoryMock.UploadToMinio with params: %#v", *e.params)
		}
	}

	afterUploadToMinioCounter := mm_atomic.LoadUint64(&m.afterUploadToMinioCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.UploadToMinioMock.defaultExpectation != nil && afterUploadToMinioCounter < 1 {
		if m.UploadToMinioMock.defaultExpectation.params == nil {
			m.t.Error("Expected call to RepositoryMock.UploadToMinio")
		} else {
			m.t.Errorf("Expected call to RepositoryMock.UploadToMinio with params: %#v", *m.UploadToMinioMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcUploadToMinio != nil && afterUploadToMinioCounter < 1 {
		m.t.Error("Expected call to RepositoryMock.UploadToMinio")
	}

	if !m.UploadToMinioMock.invocationsDone() && afterUploadToMinioCounter > 0 {
		m.t.Errorf("Expected %d calls to RepositoryMock.UploadToMinio but found %d calls",
			mm_atomic.LoadUint64(&m.UploadToMinioMock.expectedInvocations), afterUploadToMinioCounter)
	}
}
...
func (m *RepositoryMock) MinimockFinish() {
	m.finishOnce.Do(func() {
		if !m.minimockDone() {
			...
			m.MinimockCreateOrUpdateComponentRunInspect()

			m.MinimockCreateOrUpdatePipelineRunInspect()
			...
			m.MinimockGeneratePresignedURLInspect()
			...
			m.MinimockUploadToMinioInspect()
...
func (m *RepositoryMock) minimockDone() bool {
	...
	return done &&
		...
		m.MinimockCreateOrUpdateComponentRunDone() &&
		m.MinimockCreateOrUpdatePipelineRunDone() &&
		...
		m.MinimockGeneratePresignedURLDone() &&
