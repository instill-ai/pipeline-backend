...
| [Parameter](#semantic-segmentation-parameter) | `parameter` | object | This object contains configuration options that allow customization of the semantic segmentation task, such as adjusting thresholds or model settings. |
</div>


<details>
<summary> Input Objects in Semantic Segmentation</summary>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Usage](#semantic-segmentation-usage) | `usage` | object | Provides statistics related to the usage of the segmentation request. This information can be useful for monitoring and analyzing system performance and resource utilization. |
</div>
</details>
...
| [Parameter](#instance-segmentation-parameter) | `parameter` | object | Placeholder for additional input parameters, providing flexibility for task customization. |
</div>


<details>
<summary> Input Objects in Instance Segmentation</summary>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| [Usage](#instance-segmentation-usage) | `usage` | object | Data on the resource usage for the request, including processing time and resource allocation. |
</div>
</details>
