...
| Model (required) | `model` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`o1`</li><li>`o1-preview`</li><li>`o1-mini`</li><li>`gpt-4o-mini`</li><li>`gpt-4o`</li><li>`gpt-4o-2024-05-13`</li><li>`gpt-4o-2024-08-06`</li><li>`gpt-4-turbo`</li><li>`gpt-4-turbo-2024-04-09`</li><li>`gpt-4-0125-preview`</li><li>`gpt-4-turbo-preview`</li><li>`gpt-4-1106-preview`</li><li>`gpt-4-vision-preview`</li><li>`gpt-4`</li><li>`gpt-4-0314`</li><li>`gpt-4-0613`</li><li>`gpt-4-32k`</li><li>`gpt-4-32k-0314`</li><li>`gpt-4-32k-0613`</li><li>`gpt-3.5-turbo`</li><li>`gpt-3.5-turbo-16k`</li><li>`gpt-3.5-turbo-0301`</li><li>`gpt-3.5-turbo-0613`</li><li>`gpt-3.5-turbo-1106`</li><li>`gpt-3.5-turbo-0125`</li><li>`gpt-3.5-turbo-16k-0613`</li></ul></details></small></small> | ID of the model to use. |
| Prompt (required) | `prompt` | string | The prompt text. |
| System Message | `system-message` | string | The system message helps set the behavior of the assistant. For example, you can modify the personality of the assistant or provide specific instructions about how it should behave throughout the conversation. By default, the model's behavior is using a generic message as "You are a helpful assistant.". |
| Image | `images` | array[string] | The images. |
| Chat History | `chat-history` | array[object ([chat-message](#text-generation-chat-message))] | Incorporate external chat history, specifically previous messages within the conversation. Please note that System Message will be ignored and will not have any effect when this field is populated. Each message should adhere to the format \{"role": "The message role, i.e. ''system'', ''user'' or ''assistant''", "content": "message content"\}. |
...
| Prediction | `prediction` | object ([chat-message](#text-generation-chat-message)) | Configuration for a Predicted Output, which can greatly improve response times when large parts of the model response are known ahead of time. This is most common when you are regenerating a file with only minor changes to most of the content. |
| Tools | `tools` | array[object ([tools](#text-generation-tools))] | A list of tools the model may call. Currently, only functions are supported as a tool. Use this to provide a list of functions the model may generate JSON inputs for. A max of 128 functions are supported. |
...
| Reasoning Effort | `reasoning-effort` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`minimal`</li><li>`low`</li><li>`medium`</li><li>`high`</li></ul></details></small></small> | Constrains effort on reasoning for reasoning models. Currently supported values are minimal, low, medium, and high. Reducing reasoning effort can result in faster responses and fewer tokens used on reasoning in a response. |
| Verbosity | `verbosity` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`low`</li><li>`medium`</li><li>`high`</li></ul></details></small></small> | Constrains the verbosity of the model's response. Lower values will result in more concise responses, while higher values will result in more verbose responses. Currently supported values are low, |
</div>
...
| Tool Calls (optional) | `tool-calls` | array[object ([tool-calls](#text-generation-tool-calls))] | The tool calls generated by the model, such as function calls. |
| Usage (optional) | `usage` | object ([usage](#text-generation-usage)) | Usage statistics related to the query. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="text-generation-chat-message">Chat Message <sup><small><small>Referenced in <a href="#text-generation-input">Input</a></small></small></sup></h4>
...
| Content | `content` | array[object ([content](#text-generation-content))] | The message content. |
</div>

<h4 id="text-generation-completion-token-details">Completion token details <sup><small><small>Referenced in <a href="#text-generation-usage">Usage</a></small></small></sup></h4>
...
<h4 id="text-generation-content">Content <sup><small><small>Referenced in <a href="#text-generation-chat-message">Chat Message</a></small></small></sup></h4>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| Image URL | `image-url` | object ([chat-message](#text-generation-chat-message)) | The image URL |
...
<h4 id="text-generation-function">Function <sup><small><small>Referenced in <a href="#text-generation-tool-calls">Tool Calls</a>, <a href="#text-generation-tools">Tools</a></small></small></sup></h4>
...
<h4 id="text-generation-image-url">Image URL <sup><small><small>Referenced in <a href="#text-generation-content">Content</a></small></small></sup></h4>
...
<h4 id="text-generation-prediction">Prediction <sup><small><small>Referenced in <a href="#text-generation-input">Input</a></small></small></sup></h4>
...
<h4 id="text-generation-prompt-token-details">Prompt token details <sup><small><small>Referenced in <a href="#text-generation-usage">Usage</a></small></small></sup></h4>
...
<h4 id="text-generation-tool-calls">Tool Calls <sup><small><small>Referenced in <a href="#text-generation-output">Output</a></small></small></sup></h4>
...
| Function | `function` | object ([function](#text-generation-function)) | The function that the model called. |
</div>

<h4 id="text-generation-tools">Tools <sup><small><small>Referenced in <a href="#text-generation-input">Input</a></small></small></sup></h4>
...
| Field | Field ID | Type | Note |
| :--- | :--- | :--- | :--- |
| Function | `function` | object ([function](#text-generation-function)) | The function to call. |
</div>

<h4 id="text-generation-usage">Usage <sup><small><small>Referenced in <a href="#text-generation-output">Output</a></small></small></sup></h4>

Usage statistics related to the query.
...
| Prompt token details | `prompt-token-details` | object ([prompt-token-details](#text-generation-prompt-token-details)) | Breakdown of tokens used in the prompt. |
| Completion token details | `completion-token-details` | object ([completion-token-details](#text-generation-completion-token-details)) | Breakdown of tokens used in a completion. |
</div>
...
| Model (required) | `model` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`text-embedding-ada-002`</li><li>`text-embedding-3-small`</li><li>`text-embedding-3-large`</li></ul></details></small></small> | ID of the model to use. |
...
| Model (required) | `model` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`whisper-1`</li></ul></details></small></small> | ID of the model to use. Only `whisper-1` is currently available. |
...
<h4 id="text-to-speech-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_TEXT_TO_SPEECH` |
| Model (required) | `model` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`tts-1`</li><li>`tts-1-hd`</li></ul></details></small></small> | One of the available TTS models: `tts-1` or `tts-1-hd`. |
| Text (required) | `text` | string | The text to generate audio for. The maximum length is 4096 characters. |
| Voice (required) | `voice` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`alloy`</li><li>`echo`</li><li>`fable`</li><li>`onyx`</li><li>`nova`</li><li>`shimmer`</li></ul></details></small></small> | The voice to use when generating the audio. Supported voices are `alloy`, `echo`, `fable`, `onyx`, `nova`, and `shimmer`. |
| Response Format | `response-type` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`mp3`</li><li>`opus`</li><li>`aac`</li><li>`flac`</li></ul></details></small></small> | The format to audio in. Supported formats are `mp3`, `opus`, `aac`, and `flac`. |
| Speed | `speed` | number | The speed of the generated audio. Select a value from `0.25` to `4.0`. `1.0` is the default. |
</div>

<h4 id="text-to-speech-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Model (required) | `model` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`dall-e-2`</li><li>`dall-e-3`</li></ul></details></small></small> | The model to use for image generation. |
...
| Quality | `quality` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`standard`</li><li>`hd`</li></ul></details></small></small> | The quality of the image that will be generated. `hd` creates images with finer details and greater consistency across the image. This param is only supported for `dall-e-3`. |
| Size | `size` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`256x256`</li><li>`512x512`</li><li>`1024x1024`</li><li>`1792x1024`</li><li>`1024x1792`</li></ul></details></small></small> | The size of the generated images. Must be one of `256x256`, `512x512`, or `1024x1024` for `dall-e-2`. Must be one of `1024x1024`, `1792x1024`, or `1024x1792` for `dall-e-3` models. |
| N | `style` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`vivid`</li><li>`natural`</li></ul></details></small></small> | The style of the generated images. Must be one of `vivid` or `natural`. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images. This param is only supported for `dall-e-3`. |
</div>
...
| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Images | `results` | array[object ([results](#text-to-image-image))] | Generated results. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="text-to-image-image">Image <sup><small><small>Referenced in <a href="#text-to-image-output">Output</a></small></small></sup></h4>
