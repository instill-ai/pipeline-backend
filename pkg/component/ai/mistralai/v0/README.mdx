...
| Model Name (required) | `model-name` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`open-mixtral-8x22b`</li><li>`open-mixtral-8x7b`</li><li>`open-mistral-7b`</li><li>`mistral-large-latest`</li><li>`mistral-small-latest`</li><li>`codestral-latest`</li></ul></details></small></small> | The Mistral model to be used. |
...
| Usage (optional) | `usage` | object ([chat-usage](#text-generation-chat-usage)) | Token usage on the Mistral platform text generation models. |
</div>
...
Token usage on the Mistral platform text generation models.
...
| Model Name (required) | `model-name` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`mistral-embed`</li></ul></details></small></small> | The Mistral embed model to be used. |
...
| Usage (optional) | `usage` | object ([embedding-usage](#text-embeddings-usage)) | Token usage on the Mistral platform embedding models. |
</div>
...
Token usage on the Mistral platform embedding models.
