...
<h4 id="subsample-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="subsample-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="extract-audio-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="extract-audio-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="extract-frames-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="extract-frames-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="embed-audio-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="embed-audio-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
