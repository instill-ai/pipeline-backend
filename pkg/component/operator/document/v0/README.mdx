...
| Use Docling to Convert PDF to Markdown | `use-docling-converter` | boolean | When converting PDF to Markdown, use `docling` instead of `pdfplumber`. This converter is more resource-intensive but usually yields more accurate results.  |
</div>
