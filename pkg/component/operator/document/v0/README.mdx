...
<h4 id="convert-to-markdown-input">Input</h4>
...
| Converter | `converter` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`pdfplumber`</li><li>`docling`</li></ul></details></small></small> | The conversion engine used in the transformation. For now, it only applies to PDF to Markdown conversions. `pdfplumber` is quicker than Docling, but it typically produces less accurate results. |
</div>

<h4 id="convert-to-markdown-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="convert-to-text-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="convert-to-text-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="convert-to-images-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="convert-to-images-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="split-in-pages-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="split-in-pages-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
