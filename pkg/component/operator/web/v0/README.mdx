...
| [Filter](#crawl-site-filter) | `filter` | object | A way to filter the URLs to crawl. If empty, all URLs will be crawled. Refer to the [Regex](#crawl-site-regex) and [Substring](#crawl-site-substring) for more details. |
</div>
...
<details>
<summary>The <code>filter</code> Object </summary>

<h4 id="crawl-site-filter">Filter</h4>

`filter` must fulfill one of the following schemas:

<h5 id="crawl-site-regex"><code>Regex</code></h5>
...
| Filter Method | `filter-method` | string |  Must be `"Regex"`   |
| Include Patterns | `include-patterns` | array |  When the URL is matched, the URL will be crawled.  |
</div>

<h5 id="crawl-site-substring"><code>Substring</code></h5>
...
| Exclude Substring | `exclude-substrings` | array |  When the URL contains the substrings, the URL will not be crawled.  |
| Filter Method | `filter-method` | string |  Must be `"Substring"`   |
| Include Substring | `include-substrings` | array |  When the URL contains the substrings, the URL will be crawled.  |
</div>
</details>
