...
<h4 id="crawl-site-input">Input</h4>
...
| Filter | `filter` | object ([page-info](#crawl-site-page-information)) | Filtering based on [regular expression](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_expressions). The URL will be crawled if it matches either include-pattern or not match exclude-pattern. When both include-pattern and exclude-pattern are empty, all URLs will be crawled. It will process exclude-pattern first, then include-pattern. When exclude-pattern is not empty, only URLs that do not match exclude-pattern will be crawled. When include-pattern is not empty, only URLs that match include-pattern will be crawled. |
</div>

<h4 id="crawl-site-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Pages | `pages` | array[object ([page-info](#crawl-site-page-information))] | The link and title of webpages crawled by the crawler. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="crawl-site-filter">Filter <sup><small><small>Referenced in <a href="#crawl-site-input">Input</a></small></small></sup></h4>
...
<h4 id="crawl-site-page-information">Page Information <sup><small><small>Referenced in <a href="#crawl-site-output">Output</a></small></small></sup></h4>
...
<h4 id="crawl-site-page-info">Page Info <sup><small><small>Referenced in <a href="#crawl-site-output">Output</a></small></small></sup></h4>

The link and title of webpages crawled by the crawler.
...
<h4 id="scrape-pages-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Scrape Method (required) | `scrape-method` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`http`</li><li>`chrome-simulator`</li></ul></details></small></small> | Defines the method used for web scraping. Available options include `http` for standard HTTP-based scraping and `chrome-simulator` for scraping through a simulated Chrome browser environment. |
...
<h4 id="scrape-pages-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Pages | `pages` | array[object ([pages](#scrape-pages-pages))] | A list of page objects that have been scraped. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="scrape-pages-metadata">Metadata <sup><small><small>Referenced in <a href="#scrape-pages-pages">Pages</a></small></small></sup></h4>
...
<h4 id="scrape-pages-pages">Pages <sup><small><small>Referenced in <a href="#scrape-pages-output">Output</a></small></small></sup></h4>

A list of page objects that have been scraped.
...
| Metadata | `metadata` | object ([metadata](#scrape-pages-metadata)) | The metadata of the webpage. |
| Links on Page | `links-on-page` | array[string] | The list of links on the webpage. |
</div>
...
<h4 id="scrape-sitemap-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="scrape-sitemap-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| List | `list` | array[object] | The list of information in a sitemap. |
</div>
