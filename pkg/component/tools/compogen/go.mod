...
require (
	...
	github.com/instill-ai/pipeline-backend v0.49.1-beta.0.20241224134251-c4a675c31007
...
require (
	...
	github.com/instill-ai/x v0.6.0-alpha // indirect
	...
	go.temporal.io/sdk v1.21.0 // indirect
