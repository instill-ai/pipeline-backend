...
//go:generate minimock -g -i github.com/instill-ai/protogen-go/artifact/v1alpha.ArtifactPublicServiceClient -o ./ -s "_mock.gen.go"
...
//go:generate minimock -g -i github.com/instill-ai/protogen-go/artifact/v1alpha.ArtifactPublicServiceServer -o ./ -s "_mock.gen.go"
