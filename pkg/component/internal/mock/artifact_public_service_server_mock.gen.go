...
type ArtifactPublicServiceServerMock struct {
	...
	funcGetCatalogFile          func(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest) (gp2 *mm_artifactv1alpha.GetCatalogFileResponse, err error)
	funcGetCatalogFileOrigin    string
	inspectFuncGetCatalogFile   func(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest)
	afterGetCatalogFileCounter  uint64
	beforeGetCatalogFileCounter uint64
	GetCatalogFileMock          mArtifactPublicServiceServerMockGetCatalogFile
...
func NewArtifactPublicServiceServerMock(t minimock.Tester) *ArtifactPublicServiceServerMock {
	...
	m.GetCatalogFileMock = mArtifactPublicServiceServerMockGetCatalogFile{mock: m}
	m.GetCatalogFileMock.callArgs = []*ArtifactPublicServiceServerMockGetCatalogFileParams{}
...
type mArtifactPublicServiceServerMockGetCatalogFile struct {
	optional           bool
	mock               *ArtifactPublicServiceServerMock
	defaultExpectation *ArtifactPublicServiceServerMockGetCatalogFileExpectation
	expectations       []*ArtifactPublicServiceServerMockGetCatalogFileExpectation

	callArgs []*ArtifactPublicServiceServerMockGetCatalogFileParams
	mutex    sync.RWMutex
...
// ArtifactPublicServiceServerMockGetCatalogFileExpectation specifies expectation struct of the ArtifactPublicServiceServer.GetCatalogFile
type ArtifactPublicServiceServerMockGetCatalogFileExpectation struct {
	mock               *ArtifactPublicServiceServerMock
	params             *ArtifactPublicServiceServerMockGetCatalogFileParams
	paramPtrs          *ArtifactPublicServiceServerMockGetCatalogFileParamPtrs
	expectationOrigins ArtifactPublicServiceServerMockGetCatalogFileExpectationOrigins
	results            *ArtifactPublicServiceServerMockGetCatalogFileResults
	returnOrigin       string
	Counter            uint64
}

// ArtifactPublicServiceServerMockGetCatalogFileParams contains parameters of the ArtifactPublicServiceServer.GetCatalogFile
type ArtifactPublicServiceServerMockGetCatalogFileParams struct {
	ctx context.Context
	gp1 *mm_artifactv1alpha.GetCatalogFileRequest
}

// ArtifactPublicServiceServerMockGetCatalogFileParamPtrs contains pointers to parameters of the ArtifactPublicServiceServer.GetCatalogFile
type ArtifactPublicServiceServerMockGetCatalogFileParamPtrs struct {
	ctx *context.Context
	gp1 **mm_artifactv1alpha.GetCatalogFileRequest
}

// ArtifactPublicServiceServerMockGetCatalogFileResults contains results of the ArtifactPublicServiceServer.GetCatalogFile
type ArtifactPublicServiceServerMockGetCatalogFileResults struct {
	gp2 *mm_artifactv1alpha.GetCatalogFileResponse
	err error
}

// ArtifactPublicServiceServerMockGetCatalogFileOrigins contains origins of expectations of the ArtifactPublicServiceServer.GetCatalogFile
type ArtifactPublicServiceServerMockGetCatalogFileExpectationOrigins struct {
	origin    string
	originCtx string
	originGp1 string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Optional() *mArtifactPublicServiceServerMockGetCatalogFile {
	mmGetCatalogFile.optional = true
	return mmGetCatalogFile
}

// Expect sets up expected params for ArtifactPublicServiceServer.GetCatalogFile
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Expect(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest) *mArtifactPublicServiceServerMockGetCatalogFile {
	if mmGetCatalogFile.mock.funcGetCatalogFile != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by Set")
	}

	if mmGetCatalogFile.defaultExpectation == nil {
		mmGetCatalogFile.defaultExpectation = &ArtifactPublicServiceServerMockGetCatalogFileExpectation{}
	}

	if mmGetCatalogFile.defaultExpectation.paramPtrs != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by ExpectParams functions")
	}

	mmGetCatalogFile.defaultExpectation.params = &ArtifactPublicServiceServerMockGetCatalogFileParams{ctx, gp1}
...
// ExpectCtxParam1 sets up expected param ctx for ArtifactPublicServiceServer.GetCatalogFile
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) ExpectCtxParam1(ctx context.Context) *mArtifactPublicServiceServerMockGetCatalogFile {
	if mmGetCatalogFile.mock.funcGetCatalogFile != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by Set")
	}
	...
	if mmGetCatalogFile.defaultExpectation.params != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by Expect")
	}

	if mmGetCatalogFile.defaultExpectation.paramPtrs == nil {
		mmGetCatalogFile.defaultExpectation.paramPtrs = &ArtifactPublicServiceServerMockGetCatalogFileParamPtrs{}
	}
...
// ExpectGp1Param2 sets up expected param gp1 for ArtifactPublicServiceServer.GetCatalogFile
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) ExpectGp1Param2(gp1 *mm_artifactv1alpha.GetCatalogFileRequest) *mArtifactPublicServiceServerMockGetCatalogFile {
	if mmGetCatalogFile.mock.funcGetCatalogFile != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by Set")
	}
	...
	mmGetCatalogFile.defaultExpectation.paramPtrs.gp1 = &gp1
	mmGetCatalogFile.defaultExpectation.expectationOrigins.originGp1 = minimock.CallerInfo(1)

	return mmGetCatalogFile
}

// Inspect accepts an inspector function that has same arguments as the ArtifactPublicServiceServer.GetCatalogFile
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Inspect(f func(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest)) *mArtifactPublicServiceServerMockGetCatalogFile {
	if mmGetCatalogFile.mock.inspectFuncGetCatalogFile != nil {
		mmGetCatalogFile.mock.t.Fatalf("Inspect function is already set for ArtifactPublicServiceServerMock.GetCatalogFile")
	}
...
// Return sets up results that will be returned by ArtifactPublicServiceServer.GetCatalogFile
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Return(gp2 *mm_artifactv1alpha.GetCatalogFileResponse, err error) *ArtifactPublicServiceServerMock {
	if mmGetCatalogFile.mock.funcGetCatalogFile != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by Set")
	}

	if mmGetCatalogFile.defaultExpectation == nil {
		mmGetCatalogFile.defaultExpectation = &ArtifactPublicServiceServerMockGetCatalogFileExpectation{mock: mmGetCatalogFile.mock}
	}
	mmGetCatalogFile.defaultExpectation.results = &ArtifactPublicServiceServerMockGetCatalogFileResults{gp2, err}
	mmGetCatalogFile.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGetCatalogFile.mock
}

// Set uses given function f to mock the ArtifactPublicServiceServer.GetCatalogFile method
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Set(f func(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest) (gp2 *mm_artifactv1alpha.GetCatalogFileResponse, err error)) *ArtifactPublicServiceServerMock {
	if mmGetCatalogFile.defaultExpectation != nil {
		mmGetCatalogFile.mock.t.Fatalf("Default expectation is already set for the ArtifactPublicServiceServer.GetCatalogFile method")
	}

	if len(mmGetCatalogFile.expectations) > 0 {
		mmGetCatalogFile.mock.t.Fatalf("Some expectations are already set for the ArtifactPublicServiceServer.GetCatalogFile method")
	}
...
// When sets expectation for the ArtifactPublicServiceServer.GetCatalogFile which will trigger the result defined by the following
// Then helper
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) When(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest) *ArtifactPublicServiceServerMockGetCatalogFileExpectation {
	if mmGetCatalogFile.mock.funcGetCatalogFile != nil {
		mmGetCatalogFile.mock.t.Fatalf("ArtifactPublicServiceServerMock.GetCatalogFile mock is already set by Set")
	}

	expectation := &ArtifactPublicServiceServerMockGetCatalogFileExpectation{
		mock:               mmGetCatalogFile.mock,
		params:             &ArtifactPublicServiceServerMockGetCatalogFileParams{ctx, gp1},
		expectationOrigins: ArtifactPublicServiceServerMockGetCatalogFileExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmGetCatalogFile.expectations = append(mmGetCatalogFile.expectations, expectation)
	return expectation
}

// Then sets up ArtifactPublicServiceServer.GetCatalogFile return parameters for the expectation previously defined by the When method
func (e *ArtifactPublicServiceServerMockGetCatalogFileExpectation) Then(gp2 *mm_artifactv1alpha.GetCatalogFileResponse, err error) *ArtifactPublicServiceServerMock {
	e.results = &ArtifactPublicServiceServerMockGetCatalogFileResults{gp2, err}
	return e.mock
}

// Times sets number of times ArtifactPublicServiceServer.GetCatalogFile should be invoked
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Times(n uint64) *mArtifactPublicServiceServerMockGetCatalogFile {
	if n == 0 {
		mmGetCatalogFile.mock.t.Fatalf("Times of ArtifactPublicServiceServerMock.GetCatalogFile mock can not be zero")
	}
...
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) invocationsDone() bool {
...
// GetCatalogFile implements mm_artifactv1alpha.ArtifactPublicServiceServer
func (mmGetCatalogFile *ArtifactPublicServiceServerMock) GetCatalogFile(ctx context.Context, gp1 *mm_artifactv1alpha.GetCatalogFileRequest) (gp2 *mm_artifactv1alpha.GetCatalogFileResponse, err error) {
	...
	if mmGetCatalogFile.inspectFuncGetCatalogFile != nil {
		mmGetCatalogFile.inspectFuncGetCatalogFile(ctx, gp1)
	}

	mm_params := ArtifactPublicServiceServerMockGetCatalogFileParams{ctx, gp1}
	...
	if mmGetCatalogFile.GetCatalogFileMock.defaultExpectation != nil {
		...
		mm_got := ArtifactPublicServiceServerMockGetCatalogFileParams{ctx, gp1}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmGetCatalogFile.t.Errorf("ArtifactPublicServiceServerMock.GetCatalogFile got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.gp1 != nil && !minimock.Equal(*mm_want_ptrs.gp1, mm_got.gp1) {
				mmGetCatalogFile.t.Errorf("ArtifactPublicServiceServerMock.GetCatalogFile got unexpected parameter gp1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmGetCatalogFile.GetCatalogFileMock.defaultExpectation.expectationOrigins.originGp1, *mm_want_ptrs.gp1, mm_got.gp1, minimock.Diff(*mm_want_ptrs.gp1, mm_got.gp1))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmGetCatalogFile.t.Errorf("ArtifactPublicServiceServerMock.GetCatalogFile got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
		...
		if mm_results == nil {
			mmGetCatalogFile.t.Fatal("No results are set for the ArtifactPublicServiceServerMock.GetCatalogFile")
		}
		return (*mm_results).gp2, (*mm_results).err
	}
	if mmGetCatalogFile.funcGetCatalogFile != nil {
		return mmGetCatalogFile.funcGetCatalogFile(ctx, gp1)
	}
	mmGetCatalogFile.t.Fatalf("Unexpected call to ArtifactPublicServiceServerMock.GetCatalogFile. %v %v", ctx, gp1)
	return
}

// GetCatalogFileAfterCounter returns a count of finished ArtifactPublicServiceServerMock.GetCatalogFile invocations
func (mmGetCatalogFile *ArtifactPublicServiceServerMock) GetCatalogFileAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetCatalogFile.afterGetCatalogFileCounter)
}

// GetCatalogFileBeforeCounter returns a count of ArtifactPublicServiceServerMock.GetCatalogFile invocations
func (mmGetCatalogFile *ArtifactPublicServiceServerMock) GetCatalogFileBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmGetCatalogFile.beforeGetCatalogFileCounter)
}

// Calls returns a list of arguments used in each call to ArtifactPublicServiceServerMock.GetCatalogFile.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmGetCatalogFile *mArtifactPublicServiceServerMockGetCatalogFile) Calls() []*ArtifactPublicServiceServerMockGetCatalogFileParams {
	mmGetCatalogFile.mutex.RLock()

	argCopy := make([]*ArtifactPublicServiceServerMockGetCatalogFileParams, len(mmGetCatalogFile.callArgs))
...
// the number of defined expectations
func (m *ArtifactPublicServiceServerMock) MinimockGetCatalogFileDone() bool {
...
func (m *ArtifactPublicServiceServerMock) MinimockGetCatalogFileInspect() {
	for _, e := range m.GetCatalogFileMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ArtifactPublicServiceServerMock.GetCatalogFile at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.GetCatalogFileMock.invocationsDone() && afterGetCatalogFileCounter > 0 {
		m.t.Errorf("Expected %d calls to ArtifactPublicServiceServerMock.GetCatalogFile at\n%s but found %d calls",
