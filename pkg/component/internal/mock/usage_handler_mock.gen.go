...
type UsageHandlerMockCheckExpectation struct {
	...
	expectationOrigins UsageHandlerMockCheckExpectationOrigins
...
type UsageHandlerMockCheckExpectationOrigins struct {
	origin       string
	originCtx    string
	originInputs string
}
...
func (mmCheck *mUsageHandlerMockCheck) ExpectInputsParam2(inputs []*structpb.Struct) *mUsageHandlerMockCheck {
	...
	mmCheck.defaultExpectation.expectationOrigins.originInputs = minimock.CallerInfo(1)
...
func (mmCheck *mUsageHandlerMockCheck) When(ctx context.Context, inputs []*structpb.Struct) *UsageHandlerMockCheckExpectation {
	...
	expectation := &UsageHandlerMockCheckExpectation{
		...
		expectationOrigins: UsageHandlerMockCheckExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Check implements mm_base.UsageHandler
	...
	if mmCheck.CheckMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCheck.t.Errorf("UsageHandlerMock.Check got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.inputs != nil && !minimock.Equal(*mm_want_ptrs.inputs, mm_got.inputs) {
				mmCheck.t.Errorf("UsageHandlerMock.Check got unexpected parameter inputs, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCheck.CheckMock.defaultExpectation.expectationOrigins.originInputs, *mm_want_ptrs.inputs, mm_got.inputs, minimock.Diff(*mm_want_ptrs.inputs, mm_got.inputs))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCheck.t.Errorf("UsageHandlerMock.Check got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (m *UsageHandlerMock) MinimockCheckInspect() {
	for _, e := range m.CheckMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UsageHandlerMock.Check at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.CheckMock.invocationsDone() && afterCheckCounter > 0 {
		m.t.Errorf("Expected %d calls to UsageHandlerMock.Check at\n%s but found %d calls",
...
type UsageHandlerMockCollectExpectation struct {
	...
	expectationOrigins UsageHandlerMockCollectExpectationOrigins
...
type UsageHandlerMockCollectExpectationOrigins struct {
	origin        string
	originCtx     string
	originInputs  string
...
func (mmCollect *mUsageHandlerMockCollect) Expect(ctx context.Context, inputs []*structpb.Struct, outputs []*structpb.Struct) *mUsageHandlerMockCollect {
	...
	mmCollect.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
...
func (mmCollect *mUsageHandlerMockCollect) ExpectCtxParam1(ctx context.Context) *mUsageHandlerMockCollect {
	...
	mmCollect.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)
...
func (mmCollect *mUsageHandlerMockCollect) ExpectInputsParam2(inputs []*structpb.Struct) *mUsageHandlerMockCollect {
	...
	mmCollect.defaultExpectation.expectationOrigins.originInputs = minimock.CallerInfo(1)
...
func (mmCollect *mUsageHandlerMockCollect) ExpectOutputsParam3(outputs []*structpb.Struct) *mUsageHandlerMockCollect {
	...
	mmCollect.defaultExpectation.expectationOrigins.originOutputs = minimock.CallerInfo(1)
...
func (mmCollect *mUsageHandlerMockCollect) Return(err error) *UsageHandlerMock {
	...
	mmCollect.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
...
func (mmCollect *mUsageHandlerMockCollect) Set(f func(ctx context.Context, inputs []*structpb.Struct, outputs []*structpb.Struct) (err error)) *UsageHandlerMock {
	...
	mmCollect.mock.funcCollectOrigin = minimock.CallerInfo(1)
	return mmCollect.mock
}
...
func (mmCollect *mUsageHandlerMockCollect) When(ctx context.Context, inputs []*structpb.Struct, outputs []*structpb.Struct) *UsageHandlerMockCollectExpectation {
	...
	expectation := &UsageHandlerMockCollectExpectation{
		...
		expectationOrigins: UsageHandlerMockCollectExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
func (mmCollect *mUsageHandlerMockCollect) Times(n uint64) *mUsageHandlerMockCollect {
	...
	mmCollect.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmCollect
}
...
// Collect implements mm_base.UsageHandler
func (mmCollect *UsageHandlerMock) Collect(ctx context.Context, inputs []*structpb.Struct, outputs []*structpb.Struct) (err error) {
	...
	if mmCollect.CollectMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCollect.t.Errorf("UsageHandlerMock.Collect got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCollect.CollectMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.inputs != nil && !minimock.Equal(*mm_want_ptrs.inputs, mm_got.inputs) {
				mmCollect.t.Errorf("UsageHandlerMock.Collect got unexpected parameter inputs, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCollect.CollectMock.defaultExpectation.expectationOrigins.originInputs, *mm_want_ptrs.inputs, mm_got.inputs, minimock.Diff(*mm_want_ptrs.inputs, mm_got.inputs))
			}

			if mm_want_ptrs.outputs != nil && !minimock.Equal(*mm_want_ptrs.outputs, mm_got.outputs) {
				mmCollect.t.Errorf("UsageHandlerMock.Collect got unexpected parameter outputs, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCollect.CollectMock.defaultExpectation.expectationOrigins.originOutputs, *mm_want_ptrs.outputs, mm_got.outputs, minimock.Diff(*mm_want_ptrs.outputs, mm_got.outputs))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCollect.t.Errorf("UsageHandlerMock.Collect got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmCollect.CollectMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}
...
func (m *UsageHandlerMock) MinimockCollectInspect() {
	for _, e := range m.CollectMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UsageHandlerMock.Collect at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if m.CollectMock.defaultExpectation != nil && afterCollectCounter < 1 {
		if m.CollectMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to UsageHandlerMock.Collect at\n%s", m.CollectMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to UsageHandlerMock.Collect at\n%s with params: %#v", m.CollectMock.defaultExpectation.expectationOrigins.origin, *m.CollectMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcCollect != nil && afterCollectCounter < 1 {
		m.t.Errorf("Expected call to UsageHandlerMock.Collect at\n%s", m.funcCollectOrigin)
	}

	if !m.CollectMock.invocationsDone() && afterCollectCounter > 0 {
		m.t.Errorf("Expected %d calls to UsageHandlerMock.Collect at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.CollectMock.expectedInvocations), m.CollectMock.expectedInvocationsOrigin, afterCollectCounter)
	}
}
