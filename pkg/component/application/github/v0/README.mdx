...
<h4 id="list-pull-requests-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| State | `state` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`open`</li><li>`closed`</li><li>`all`</li></ul></details></small></small> | State of the PRs, including open, closed, all. Default is open. |
| Sort | `sort` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`created`</li><li>`updated`</li><li>`popularity`</li><li>`long-running`</li></ul></details></small></small> | Sort the PRs by created, updated, popularity, or long-running. Default is created. |
| Direction | `direction` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`asc`</li><li>`desc`</li></ul></details></small></small> | Direction of the sort, including asc or desc. Default is desc. |
...
<h4 id="list-pull-requests-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Pull Requests | `pull-requests` | array[object ([pull-requests](#list-pull-requests-pull-request))] | An array of PRs. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="list-pull-requests-commit">Commit <sup><small><small>Referenced in <a href="#list-pull-requests-pull-request">Pull Request</a></small></small></sup></h4>
...
| Commit stats | `stats` | object ([commitStats](#list-pull-requests-commit-stats)) | Stats of changes. |
| Files | `files` | array[object ([commitFile](#list-pull-requests-commitfile))] | Files in the commit. |
</div>

<h4 id="list-pull-requests-commit-file">Commit File <sup><small><small>Referenced in <a href="#list-pull-requests-commit">Commit</a></small></small></sup></h4>

A file in the commit.
...
<h4 id="list-pull-requests-pull-request">Pull Request <sup><small><small>Referenced in <a href="#list-pull-requests-output">Output</a></small></small></sup></h4>
...
| Commits | `commits` | array[object ([commit](#list-pull-requests-commit))] | Commits in the PR. |
</div>

<h4 id="list-pull-requests-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#list-pull-requests-commit">Commit</a></small></small></sup></h4>
...
<h4 id="get-pull-request-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-pull-request-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Commits (optional) | `commits` | array[object ([commit](#get-pull-request-commit))] | Commits in the PR. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="get-pull-request-commit">Commit <sup><small><small>Referenced in <a href="#get-pull-request-output">Output</a></small></small></sup></h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Commit stats | `stats` | object ([commitStats](#get-pull-request-commit-stats)) | Stats of changes. |
| Files | `files` | array[object ([commitFile](#get-pull-request-commitfile))] | Files in the commit. |
</div>

<h4 id="get-pull-request-commit-file">Commit File <sup><small><small>Referenced in <a href="#get-pull-request-commit">Commit</a></small></small></sup></h4>
...
<h4 id="get-pull-request-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#get-pull-request-commit">Commit</a></small></small></sup></h4>
...
<h4 id="get-commit-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-commit-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Commit Stats (optional) | `stats` | object ([commitStats](#get-commit-commit-stats)) | Stats of changes. |
| Files (optional) | `files` | array[object ([commitFile](#get-commit-commitfile))] | Files in the commit. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="get-commit-commit">Commit</h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Stats | `stats` | object ([commitStats](#get-commit-commit-stats)) |  |
| Files | `files` | array[object ([commitFile](#get-commit-commitfile))] | Files in the commit. |
</div>

<h4 id="get-commit-commitfile">Commitfile <sup><small><small>Referenced in <a href="#get-commit-output">Output</a></small></small></sup></h4>
...
<h4 id="get-commit-commitstats">Commitstats <sup><small><small>Referenced in <a href="#get-commit-commit">Commit</a>, <a href="#get-commit-output">Output</a></small></small></sup></h4>
...
<h4 id="list-review-comments-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Sort | `sort` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`created`</li><li>`updated`</li></ul></details></small></small> | Sort the comments by created, updated. Default is created. |
| Direction | `direction` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`asc`</li><li>`desc`</li></ul></details></small></small> | Direction of the sort, including asc or desc. Default is desc. |
...
<h4 id="list-review-comments-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Comments | `comments` | array[object ([reviewComments](#list-review-comments-reviewcomments))] | An array of comments. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="list-review-comments-review-comment">Review Comment <sup><small><small>Referenced in <a href="#list-review-comments-output">Output</a></small></small></sup></h4>
...
| Comment end side | `side` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`LEFT`</li><li>`RIGHT`</li><li>`side`</li></ul></details></small></small> | Side of the end line, can be one of: LEFT, RIGHT, side. LEFT is the left side of the diff (deletion), RIGHT is the right side of the diff (addition), and side is the comment on the PR as a whole. Default is side. |
| Comment start side | `start-side` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`LEFT`</li><li>`RIGHT`</li><li>`side`</li></ul></details></small></small> | Side of the start line, can be one of: LEFT, RIGHT, side. LEFT is the left side of the diff (deletion), RIGHT is the right side of the diff (addition), and side is the comment on the PR as a whole. Default is side. |
| Comment type | `subject-type` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`line`</li><li>`file`</li></ul></details></small></small> | Subject type of the comment, can be one of: line, file. Default is line. |
...
| User | `user` | object ([user](#list-review-comments-user)) | User who created the comment. |
</div>

<h4 id="list-review-comments-commit">Commit</h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Stats | `stats` | object ([commitStats](#list-review-comments-commit-stats)) |  |
| Files | `files` | array[object ([commitFile](#list-review-comments-commitfile))] | Files in the commit. |
</div>

<h4 id="list-review-comments-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#list-review-comments-commit">Commit</a></small></small></sup></h4>
...
<h4 id="list-review-comments-user">User <sup><small><small>Referenced in <a href="#list-review-comments-review-comment">Review Comment</a></small></small></sup></h4>
...
<h4 id="create-review-comment-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Comment (required) | `comment` | object ([comment](#create-review-comment-comment)) | The comment to be added. |
</div>

<h4 id="create-review-comment-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| User (optional) | `user` | object ([user](#create-review-comment-user)) | User who created the comment. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="create-review-comment-comment">Comment <sup><small><small>Referenced in <a href="#create-review-comment-input">Input</a></small></small></sup></h4>
...
<h4 id="create-review-comment-commit">Commit</h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Stats | `stats` | object ([commitStats](#create-review-comment-commit-stats)) |  |
| Files | `files` | array[object ([commitFile](#create-review-comment-commitfile))] | Files in the commit. |
</div>

<h4 id="create-review-comment-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#create-review-comment-commit">Commit</a></small></small></sup></h4>
...
<h4 id="create-review-comment-user">User <sup><small><small>Referenced in <a href="#create-review-comment-output">Output</a></small></small></sup></h4>
...
<h4 id="list-issues-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Owner (required) | `owner` | string | Owner of the repository. |
| Repository (required) | `repository` | string | Repository name. |
| State | `state` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`open`</li><li>`closed`</li><li>`all`</li></ul></details></small></small> | State of the issues, can be one of: open, closed, all. Default is open. |
| Sort | `sort` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`created`</li><li>`updated`</li><li>`popularity`</li><li>`long-running`</li></ul></details></small></small> | Sort the issues by created, updated, popularity, or long-running. Default is created. |
| Direction | `direction` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`asc`</li><li>`desc`</li></ul></details></small></small> | Direction of the sort, can be one of: asc, desc. Default is desc. |
...
<h4 id="list-issues-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Issues | `issues` | array[object ([issue](#list-issues-issue))] | An array of issues. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="list-issues-commit">Commit</h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Stats | `stats` | object ([commitStats](#list-issues-commit-stats)) |  |
| Files | `files` | array[object ([commitFile](#list-issues-commitfile))] | Files in the commit. |
</div>

<h4 id="list-issues-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#list-issues-commit">Commit</a></small></small></sup></h4>
...
<h4 id="list-issues-issue">Issue <sup><small><small>Referenced in <a href="#list-issues-output">Output</a></small></small></sup></h4>
...
<h4 id="get-issue-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-issue-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-user-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-organization-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-organization-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Organization Full (optional) | `organization` | object ([organization](#get-organization-organization-full)) | Organization Full |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="get-organization-commit">Commit</h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Stats | `stats` | object ([commitStats](#get-organization-commit-stats)) |  |
| Files | `files` | array[object ([commitFile](#get-organization-commitfile))] | Files in the commit. |
</div>

<h4 id="get-organization-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#get-organization-commit">Commit</a></small></small></sup></h4>
...
<h4 id="get-organization-organization-full">Organization Full <sup><small><small>Referenced in <a href="#get-organization-output">Output</a></small></small></sup></h4>
...
| Plan | `plan` | object ([plan](#get-organization-plan)) | The organization's plan details. |
...
<h4 id="get-organization-plan">Plan <sup><small><small>Referenced in <a href="#get-organization-organization-full">Organization Full</a></small></small></sup></h4>

The organization's plan details.
...
<h4 id="create-issue-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="create-issue-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="create-webhook-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Content Type | `content-type` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`json`</li><li>`form`</li></ul></details></small></small> | Content type of the webhook, can be one of: json, form. Default is json. |
...
<h4 id="create-webhook-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Config (optional) | `config` | object ([config](#create-webhook-config)) | Configuration of the webhook. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="create-webhook-commit">Commit</h4>
...
| Commit SHA | `sha` | string | SHA of the commit. |
| Commit message | `message` | string | Message of the commit. |
| Stats | `stats` | object ([commitStats](#create-webhook-commit-stats)) |  |
| Files | `files` | array[object ([commitFile](#create-webhook-commitfile))] | Files in the commit. |
</div>

<h4 id="create-webhook-commit-stats">Commit stats <sup><small><small>Referenced in <a href="#create-webhook-commit">Commit</a></small></small></sup></h4>
...
<h4 id="create-webhook-config">Config <sup><small><small>Referenced in <a href="#create-webhook-output">Output</a></small></small></sup></h4>
