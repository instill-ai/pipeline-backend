...
connection](https://docs.instill-ai.com/docs/set-up-component#creating-a-connection)
...
<h4 id="read-message-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="read-message-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Conversations | `conversations` | array[object ([conversations](#read-message-conversation-details))] | An array of conversations with thread messages. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="read-message-conversation-details">conversation details <sup><small><small>Referenced in <a href="#read-message-output">Output</a></small></small></sup></h4>

An array of conversations with thread messages.
...
| Replied messages | `thread-reply-messages` | array[object ([thread-reply-messages](#read-message-relied-details))] | replies in a conversation. |
</div>

<h4 id="read-message-relied-details">relied details <sup><small><small>Referenced in <a href="#read-message-conversation-details">conversation details</a></small></small></sup></h4>
...
<h4 id="send-message-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="send-message-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
