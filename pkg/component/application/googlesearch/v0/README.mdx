...
lang: "en-US"
draft: false
description: "Learn about how to set up a Google Search component https://github.com/instill-ai/instill-core"
---
...
| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Results | `results` | array[object ([result](#search-result))] | The returned search results from Google. |
</div>
...
The returned search results from Google.
