...
| Name | `name` | string | Provide the company name for which you want to find prospects.  |
| [Revenue Size](#find-prospects-revenue-size) | `revenue-size` | object | Provide the min or max revenue size of the company you want to find prospects. If you don't provide any value, it will return all the prospects.  |
...
Provide the min or max revenue size of the company you want to find prospects. If you don't provide any value, it will return all the prospects.
...
| Seniority | `seniority` | string | Provide the seniority of the prospects you want to filter.  <br/><details><summary><strong>Enum values</strong></summary><ul><li>`Executive`</li><li>`Director`</li><li>`SeniorIndividualContributor`</li><li>`VP`</li><li>`Manager`</li><li>`Other`</li></ul></details>  |
</div>
</details>
