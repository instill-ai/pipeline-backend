...
| [Order By](#find-prospects-order-by) | `order-by` | object | Sort the prospects' info after getting the results based on company name. You can sort the prospects based on the job title and seniority. If you don't provide any value, it will return the prospects in the order they are found. If you provide both values, it will first sort the prospects based on the job title and then based on the seniority. |
</div>
...
Sort the prospects' info after getting the results based on company name. You can sort the prospects based on the job title and seniority. If you don't provide any value, it will return the prospects in the order they are found. If you provide both values, it will first sort the prospects based on the job title and then based on the seniority.
