...
<h4 id="create-sprint-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="create-sprint-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Update History | `update-history` | object ([common-query-params/update-history](#get-issue-common-query-params-update-history)) | Whether the action taken is added to the user's Recent history, as shown under `Your Work` in Jira. |
</div>
...
<h4 id="get-sprint-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="get-sprint-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="list-boards-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Board Type | `board-type` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`scrum`</li><li>`kanban`</li><li>`simple`</li></ul></details></small></small> | The type of board, can be: scrum, kanban, simple. Default is simple. |
| Name | `name` | string | Name filters results to boards that match or partially match the specified name. Default is empty. |
| Start At | `start-at` | object ([common-query-params/start-at](#list-boards-common-query-params-start-at)) | The starting index of the returned boards. Base index: 0. Default is 0. |
| Max Results | `max-results` | object ([common-query-params/max-results](#list-boards-common-query-params-max-results)) | The maximum number of boards to return. Default is 50. |
</div>

<h4 id="list-boards-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Boards (optional) | `boards` | array[object ([boards](#list-boards-boards))] | A array of boards in Jira. |
...
<h4 id="list-boards-boards">Boards <sup><small><small>Referenced in <a href="#list-boards-output">Output</a></small></small></sup></h4>

A array of boards in Jira.
...
| Start At | `start-at` | object ([common-query-params/start-at](#list-issues-common-query-params-start-at)) | The starting index of the returned boards. Base index: 0. Default is 0. |
| Max Results | `max-results` | object ([common-query-params/max-results](#list-issues-common-query-params-max-results)) | The maximum number of boards to return. Default is 50. |
</div>
...
| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Issues (optional) | `issues` | array[object ([issue](#list-issues-issue))] | A array of issues in Jira. |
| Start At | `start-at` | integer | The starting index of the returned boards. Base index: 0. |
| Max Results | `max-results` | integer | The maximum number of boards. |
| Total | `total` | integer | The total number of boards. |
</div>
...
<h4 id="list-sprints-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
| Start At | `start-at` | object ([common-query-params/start-at](#list-sprints-common-query-params-start-at)) | The starting index of the returned boards. Base index: 0. Default is 0. |
| Max Results | `max-results` | object ([common-query-params/max-results](#list-sprints-common-query-params-max-results)) | The maximum number of boards to return. Default is 50. |
</div>

<h4 id="list-sprints-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Sprints (optional) | `sprints` | array[object ([sprint](#list-sprints-sprint))] | A array of sprints in Jira. |
| Start At | `start-at` | integer | The starting index of the returned boards. Base index: 0. |
| Max Results | `max-results` | integer | The maximum number of boards. |
| Total | `total` | integer | The total number of boards. |
</div>
...
<details>
<summary> Referenced Objects</summary>
<h4 id="list-sprints-sprint">Sprint <sup><small><small>Referenced in <a href="#list-sprints-output">Output</a></small></small></sup></h4>

A array of sprints in Jira.
...
<h4 id="update-issue-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Task ID (required) | `task` | string | `TASK_UPDATE_ISSUE` |
| Issue Key (required) | `issue-key` | object ([issue/properties/key](#update-issue-issue-properties-key)) | The key of the issue, e.g. `JRA-1330`. |
| Notify Users | `notify-users` | boolean | Whether to notify users. |
| Update | `update` | object | Update an issue in Jira. |
</div>

<h4 id="update-issue-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="update-sprint-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="update-sprint-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
