...
| :--- | :--- | :--- | :--- |
| Engine (required) | `engine` | string<br/><small><small><details><summary>Enum values</summary><ul><li>`MySQL`</li><li>`PostgreSQL`</li><li>`SQL Server`</li><li>`Oracle`</li><li>`MariaDB`</li><li>`Firebird`</li></ul></details></small></small> | Choose the engine of your database. |
...
<h4 id="create-table-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="create-table-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="drop-table-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="drop-table-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
