...
<h4 id="read-objects-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="read-objects-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>

| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Text Objects (optional) | `text-objects` | array[object ([text-objects](#read-objects-text-objects))] | The text objects in the bucket. |
| Image Objects (optional) | `image-objects` | array[object ([image-objects](#read-objects-image-objects))] | The image objects in the bucket. |
| Document Objects (optional) | `document-objects` | array[object ([document-objects](#read-objects-object))] | The document objects in the bucket. |
| Audio Objects (optional) | `audio-objects` | array[object ([audio-objects](#read-objects-object))] | The audio objects in the bucket. |
| Video Objects (optional) | `video-objects` | array[object ([video-objects](#read-objects-object))] | The video objects in the bucket. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="read-objects-attributes">Attributes <sup><small><small>Referenced in <a href="#read-objects-object">Object</a>, <a href="#read-objects-text-objects">Text Objects</a></small></small></sup></h4>
...
<h4 id="read-objects-object">Object <sup><small><small>Referenced in <a href="#read-objects-output">Output</a></small></small></sup></h4>

The document objects in the bucket.
...
| Attributes | `attributes` | object ([attributes](#read-objects-attributes)) | The attributes of the object. |
</div>

<h4 id="read-objects-text-objects">Text Objects <sup><small><small>Referenced in <a href="#read-objects-output">Output</a></small></small></sup></h4>

The text objects in the bucket.
...
<h4 id="create-bucket-input">Input</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
...
<h4 id="create-bucket-output">Output</h4>
<div class="markdown-col-no-wrap" data-col-1 data-col-2>
