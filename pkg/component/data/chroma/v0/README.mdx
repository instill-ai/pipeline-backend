...
| Field | Field ID | Type | Description |
| :--- | :--- | :--- | :--- |
| Result | `result` | object ([result](#query-result)) | Result of the vector search operation. |
| Status | `status` | string | Vector search status. |
</div>

<details>
<summary> Referenced Objects</summary>
<h4 id="query-result">Result <sup><small><small>Referenced in <a href="#query-output">Output</a></small></small></sup></h4>
...
| Items | `items` | array[object] | The items returned from the vector search operation. |
