...
| File Name | `file-name` | string |  The name of the file, please remember to add the file extension in the end of file name. e.g. 'example.pdf'. The length limitation of file name is 100 characters.  |
...
| :--- | :--- | :--- | :--- |
| Catalog ID | `catalog-id` | string |  Catalog ID that you input in the Catalog  |
| File Names | `file-names` | array |  The names of the files, please remember to add the file extension in the end of file name. e.g. 'example.pdf'. The length limitation of file name is 100 characters.  |
