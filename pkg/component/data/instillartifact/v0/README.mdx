...
The Instill Artifact component is a data component that allows users to manipulate and smart search files and data in the Instill Core Artifact platform.
