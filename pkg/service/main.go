...
type Service interface {
	...
	CreateConnection(context.Context, *pipelinepb.CreateConnectionRequest) (*pipelinepb.Connection, error)
	UpdateConnection(context.Context, *pipelinepb.UpdateConnectionRequest) (*pipelinepb.Connection, error)
	DeleteConnection(_ context.Context, namespaceID, id string) error
	GetConnection(context.Context, *pipelinepb.GetConnectionRequest) (*pipelinepb.Connection, error)
	ListConnections(context.Context, *pipelinepb.ListConnectionsRequest) (*pipelinepb.ListConnectionsResponse, error)
