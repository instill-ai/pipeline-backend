...
type Service interface {
	...
	CloneNamespacePipeline(ctx context.Context, ns resource.Namespace, id, targetNamespaceID, targetPipelineID, description string, sharing *pb.Sharing, asTemplate bool, templateOverrides *pb.TemplateOverrides) (*pb.Pipeline, error)
	...
	CloneNamespacePipelineRelease(ctx context.Context, ns resource.Namespace, pipelineUID uuid.UUID, id, targetNamespaceID, targetPipelineID, description string, sharing *pb.Sharing, asTemplate bool, templateOverrides *pb.TemplateOverrides) (*pb.Pipeline, error)
